...
"[project]/node_modules/next/dist/compiled/@ampproject/toolbox-optimizer/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(()=>{
    var __webpack_modules__ = {
        7315: (e, t, r)=>{
            "use strict";
            e.exports = {
                FileSystemCache: r(4669),
                MaxAge: r(6564),
                oneBehindFetch: r(8414),
                log: r(277),
                isAmp: r(3471)
            };
        },
        4669: (e, t, r)=>{
            ...
            const { existsSync: n, mkdirSync: s } = r(7147);
            const a = r(6113);
            const o = r(2037);
            const c = r(277);
            const l = r(7330);
            ...
            class FileSystemCache {
                static create() {
                    ...
                    const t = Object.assign(f, e);
                    try {
                        if (!t.baseDir) {
                            t.baseDir = u.join(o.tmpdir(), "ampproject-toolbox-optimizer");
                        }
                        if (!n(t.baseDir)) {
                            s(t.baseDir);
                        }
                    } catch (e) {
                        c.debug("No filesystem access, falling back to in-memory cache only", e);
                        return new l(t.maxItems);
                    }
                    return new FileSystemCache(t);
                }
                async get(e) {
                    ...
                    const n = this.createCacheFileName(e);
                    try {
                        const t = await i.readFile(n, "utf-8");
                        r = JSON.parse(t);
                        this.cache.set(e, r);
                    } catch (e) {
                        r = t;
                ...
                async set(e, t) {
                    try {
                        this.cache.set(e, t);
                        const r = this.createCacheFileName(e);
                        return i.writeFile(r, JSON.stringify(t, null, ""), "utf-8");
                    } catch (e) {
                        this.opts.log.error("Could not write cache file", e);
                    }
                }
                async clear() {
                    const e = this.opts.baseDir;
                    if (!n(e)) {
                        return;
                    }
                    let t = await i.readdir(e, {
                        withFileTypes: true
                    });
                    await Promise.all(t.map((t)=>{
                        let r = u.join(e, t.name);
                        return t.isFile() && t.name.endsWith(".json") ? i.unlink(r) : Promise.resolve();
                    }));
                }
                createCacheFileName(e) {
                    const t = a.createHash("md5").update(e).digest("hex");
                    return u.join(this.opts.baseDir, t + ".json");
                }
                async deleteDir_(e) {
                    let t = await i.readdir(e, {
                        withFileTypes: true
                    ...
                    await Promise.all(t.map((t)=>{
                        let r = u.join(e, t.name);
                        return t.isDirectory() ? this.deleteDir_(r) : i.unlink(r);
                    }));
                    await i.rmdir(e);
                }
                constructor(e){
                    this.opts = e;
                    this.cache = new l(e.maxItems);
                }
            }
            e.exports = FileSystemCache;
        },
        3471: (e)=>{
            "use strict";
            const t = "<html";
            e.exports = function isAmp(e) {
                let r = e.indexOf(t);
                if (r === -1) {
                    return false;
                }
                ...
                let n = e.substring(r, i).split(/\s+/);
                n = n.map((e)=>e.split("=")[0]);
                return n.includes("amp") || n.includes("⚡");
            };
        },
        277: (e)=>{
            "use strict";
            class Log {
                debug(e) {
                    ...
                    this.log_(this.output_.log, this.dim_(e), t);
                }
                log(e) {
                    for(var _len = arguments.length, t = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++){
                        t[_key - 1] = arguments[_key];
                ...
                info(e) {
                    ...
                    this.log_(this.output_.log, e, ...t);
                }
                success(e) {
                    for(var _len = arguments.length, t = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++){
                        t[_key - 1] = arguments[_key];
                    }
                    this.log_(this.output_.log, this.green_("SUCCESS " + e), t);
                }
                warn(e) {
                    for(var _len = arguments.length, t = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++){
                        t[_key - 1] = arguments[_key];
                    }
                    this.log_(this.output_.warn, this.yellow_("WARNING " + e), t);
                }
                error(e) {
                    for(var _len = arguments.length, t = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++){
                        t[_key - 1] = arguments[_key];
                    ...
                    this.output_.log("\n");
                    this.log_(this.output_.error, this.red_("ERROR " + e), t);
                    this.output_.log("\n");
                }
                verbose() {
                ...
                tag(e) {
                    ...
                    return new Log(e, this.verbose_, this.output_);
                }
                log_(e, t, r) {
                    if (this.prefix_) {
                        t = this.prefix_ + " " + t;
                ...
                inverse_(e) {
                    return "\x1b[7m".concat(e, "\x1b[0m");
                }
                dim_(e) {
                    return "\x1b[36m".concat(e, "\x1b[0m");
                }
                green_(e) {
                    return "\x1b[32m".concat(e, "\x1b[0m");
                }
                yellow_(e) {
                    return "\x1b[33m".concat(e, "\x1b[0m");
                }
                red_(e) {
                    return "\x1b[31m".concat(e, "\x1b[0m");
                }
                constructor(e = "", t = false, r = console){
                    this.tag_ = e;
                    this.verbose_ = t;
                    this.prefix_ = e ? this.inverse_(e) : "";
                    this.output_ = r;
                }
            }
            e.exports = new Log;
        ...
        6564: (e)=>{
            ...
            class MaxAge {
                ...
                static parse(e) {
                    ...
                    const t = e.match(/max-age=([0-9]+)[^0-9]?/i);
                    if (!t) {
                        return MaxAge.zero();
                    }
                    return MaxAge.create(t[1]);
                }
                static create(e) {
                    if (!Number.isInteger(e)) {
                        e = parseInt(e, 10);
                    }
                    return new MaxAge(Date.now(), e);
                }
                static fromObject(e, t) {
                    return new MaxAge(e, t);
                }
                isExpired() {
                    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : Date.now();
                    const t = this.value * 1e3;
                    return this.timestampInMs_ + t < e;
                }
                toObject() {
                    return {
        ...
        8414: (e, t, r)=>{
            ...
            const n = r(6564);
            const s = new Map;
            async function oneBehindFetch(e, t) {
                let r = s.get(e);
                if (!r) {
                    r = {
                        maxAge: Promise.resolve(n.zero())
                    };
                    s.set(e, r);
                }
                const a = await r.maxAge;
                if (!a.isExpired()) {
                    const e = await r.responsePromise;
                    return e.clone();
                }
                ...
                r = {
                    responsePromise: c,
                    maxAge: c.then((e)=>n.parse(e.headers.get("cache-control")))
                };
                s.set(e, r);
                const l = o || c;
                const u = await l;
            ...
            oneBehindFetch.clearCache = ()=>s.clear();
            oneBehindFetch.setDelegate = (e)=>i = e;
            e.exports = oneBehindFetch;
        },
        5601: (e, t, r)=>{
            "use strict";
            const { DomTransformer: i, TRANSFORMATIONS_AMP_FIRST: n, TRANSFORMATIONS_PAIRED_AMP: s, TRANSFORMATIONS_MINIMAL: a, DEFAULT_CONFIG: o } = r(5992);
            const c = r(3954);
            e.exports = {
                create: function() {
                    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : o;
                    return new i(e);
                },
                TRANSFORMATIONS_AMP_FIRST: n,
                TRANSFORMATIONS_MINIMAL: a,
                TRANSFORMATIONS_PAIRED_AMP: s,
                DEFAULT_CONFIG: o,
                NodeUtils: c
            };
        },
        211: (e, t, r)=>{
            ...
            e.exports = {
                ...
                appendRuntimeVersion: (e, t)=>e + "/rtv/" + t,
                isTemplate: (e)=>{
                    if (!e) {
                        return false;
                    }
                    ...
                    if (e.tagName === "script" && i(e, "template") && e.attribs.template === "amp-mustache") {
                        return true;
                    }
                    return false;
                },
                isAmpStory: (e)=>{
                    for (const t of e.children){
                        if (isAmpScriptImport(t) && t.attribs["custom-element"] === "amp-story") {
                            return true;
                        }
                    }
                    return false;
            ...
            function isAmpScriptImport(e) {
                ...
                const t = e.attribs["custom-element"] || e.attribs["custom-template"] || "";
                if (!t.startsWith("amp-")) {
                    return false;
                }
                return true;
        ...
        5992: (e, t, r)=>{
            function __ncc_wildcard$0(e) {
                if (e === "AddAmpLink") return r(5136);
                else if (e === "AddBlurryImagePlaceholders") return r(6686);
                else if (e === "AddMandatoryTags") return r(2337);
                else if (e === "AddTransformedFlag") return r(5338);
                else if (e === "AmpBoilerplateErrorHandler") return r(6716);
                else if (e === "AmpBoilerplateTransformer") return r(4039);
                else if (e === "AmpScriptCsp") return r(2419);
                else if (e === "ApplyCommonAttributes") return r(1033);
                else if (e === "ApplyLayout") return r(9112);
                else if (e === "AutoExtensionImporter") return r(898);
                else if (e === "GoogleFontsPreconnect") return r(312);
                else if (e === "Markdown") return r(2246);
                else if (e === "MinifyHtml") return r(7248);
                else if (e === "OptimizeAmpBind") return r(5552);
                else if (e === "OptimizeHeroImages") return r(5661);
                else if (e === "OptimizeImages") return r(411);
                else if (e === "PreloadHeroImage") return r(5825);
                else if (e === "PreloadImages") return r(5181);
                else if (e === "PruneDuplicateResourceHints") return r(570);
                else if (e === "RemoveAmpAttribute") return r(3781);
                else if (e === "RemoveCspNonce") return r(6924);
                else if (e === "ReorderHeadTransformer") return r(8710);
                else if (e === "RewriteAmpUrls") return r(6550);
                else if (e === "SeparateKeyframes") return r(9210);
                else if (e === "ServerSideRendering") return r(5230);
            }
            "use strict";
            const i = r(3167);
            const n = r(3269);
            ...
            class DomTransformer {
                async transformHtml(e, t) {
                    async function transform() {
                        const r = await this.doProfile("parsing", ()=>i.parse(e));
                        await this.doProfile("transform", ()=>this.transformTree(r, t));
                        return this.doProfile("serialization", ()=>i.serialize(r));
                    }
                ...
                async doProfile(e, t) {
                    ...
                    const r = this.config.profiler(e);
                    try {
                        return await t();
                    } finally{
                        r();
                ...
                async transformTree(e) {
                    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                    n.verbose(t.verbose || false);
                    const r = await o(this.config, t);
                    for (const t of this.transformers_){
                        const i = this.getTransformerId(t);
                        await this.doProfile(i, ()=>t.transform(e, r));
                    }
                }
                setConfig(e) {
                    this.config = Object.assign({}, d, e);
                    if (!this.config.runtimeVersion) {
                        this.config.runtimeVersion = new a(this.config.fetch);
                    }
                    n.verbose(this.config.verbose);
                    this.initTransformers_(this.config);
                }
                initTransformers_(e) {
                    this.transformers_ = e.transformations.map((t)=>{
                        if (typeof t === "string") {
                            t = __ncc_wildcard$0(t);
                        }
                        return new t(e);
                    });
                }
                getTransformerId(e) {
                    return e.constructor ? e.constructor.name : "custom";
                }
                constructor(e = d){
                    this.setConfig(e);
                }
            ...
            e.exports = {
                ...
                TRANSFORMATIONS_PAIRED_AMP: u,
                TRANSFORMATIONS_MINIMAL: f
            };
        },
        3585: (e)=>{
            "mode strict";
            e.exports = {
                isRenderDelayingExtension: function(e) {
                    if (e.tagName !== "script") {
                        return false;
                    }
                    const t = e.attribs["custom-element"];
                    return t === "amp-dynamic-css-classes" || t === "amp-experiment" || t === "amp-story";
                },
                isCustomElement: function(e) {
                    return e.tagName && e.tagName.startsWith("amp-");
                }
            };
        },
        1764: (e)=>{
            "use strict";
            function findMetaViewport(e) {
                for(let t = e.firstChild; t !== null; t = t.nextSibling){
                    if (t.tagName === "meta" && t.attribs.name === "viewport") {
                        return t;
                    }
                }
                return null;
            }
            function findRuntimeScript(e) {
                for(let t = e.firstChild; t !== null; t = t.nextSibling){
                    if (t.tagName === "script" && t.attribs.src && t.attribs.src.match(/^https:\/\/.+\/v0(\.js|\.mjs)$/)) {
                        return t;
                    }
                }
                return null;
            }
            function skipNodeAndChildren(e) {
                if (!e) {
                    return null;
                } else if (e.nextSibling) {
                    return e.nextSibling;
                }
                return skipNodeAndChildren(e.parent);
            }
            e.exports = {
        ...
        3954: (e, t, r)=>{
            "use strict";
            const { Element: i, DataNode: n } = r(945);
            const { removeElement: s, append: a, prepend: o } = r(9065);
            const nextNode = function(e) {
            ...
            const appendChild = function(e, t) {
                if (!t) {
                    return;
                }
                t.parent = e;
            ...
            const insertBefore = function(e, t, r) {
                if (r) {
                    o(r, t);
                    return;
                }
            ...
            const insertAfter = function(e, t, r) {
                if (r) {
                    a(r, t);
                    return;
                }
            ...
            const firstChildByTag = function(e, t) {
                if (!e || !e.children) {
                    return null;
                }
                return e.children.find((e)=>e.tagName && e.tagName === t);
            };
            const hasAttribute = function(e, t) {
                if (!e.attribs) return false;
                return t in e.attribs;
            };
            const setAttribute = function(e, t, r) {
                if (!e.attribs) e.attribs = {};
                e.attribs[t] = r;
            };
            const move = function(e, t) {
                remove(e);
                appendChild(t, e);
            };
            const createElement = (e, t)=>new i(e, t);
            const insertText = (e, t)=>{
                const r = new n("text", t);
                appendChild(e, r);
            };
            const createDocType = ()=>{
                const e = new n("directive", "!doctype html");
                return e;
            };
            e.exports = {
        ...
        2335: (e)=>{
            ...
            const n = cssLength("1", false, false);
            const s = cssLength("auto", true, false);
            const a = cssLength("44px", false, false);
            const o = cssLength("60px", false, false);
            function getLayoutClass(e) {
                if (!e) {
                    return e;
                }
                return "i-amphtml-layout-" + e;
            }
            function calculateHeight(e, t, r) {
                if ((e === "" || e === "fixed" || e === "fixed-height") && !t.isSet) {
                    switch(r){
                        case "amp-analytics":
                            return n;
                        case "amp-audio":
            ...
            function calculateWidth(e, t, r) {
                if ((e === "" || e === "fixed") && !t.isSet) {
                    switch(r){
                        case "amp-analytics":
                            return n;
                        case "amp-audio":
            ...
            function isLayoutSizeDefined(e) {
                return i.indexOf(e) > -1;
            }
            function getCssLengthStyle(e, t) {
                if (!e.isSet) {
                    return "";
                }
                if (e.isAuto) {
                    return "".concat(t, ":auto;");
                }
                return "".concat(t, ":").concat(e.numeral).concat(e.unit, ";");
            }
            function parseLayout(e) {
                if (!e) {
                    return "";
                }
                e = e.toLowerCase();
            ...
            function calculateLayout(e, t, r, i, n) {
                if (e !== "") {
                    return e;
                }
                if (!t.isSet && !r.isSet) {
                ...
                if (r.isSet && (!t.isSet || t.isAuto)) {
                    return "fixed-height";
                }
                if (r.isSet && t.isSet && (i || n)) {
                    return "responsive";
                }
                return "fixed";
            }
            function cssLength(e) {
                let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
                const n = {
                    isValid: false,
                    isSet: false,
                    isAuto: false,
                ...
                n.numeral = Number.parseFloat(a[1]);
                e = a[2];
                if (e === "") {
                    n.unit = "px";
                    n.isValid = true;
        ...
        5470: (e, t, r)=>{
            "use strict";
            const i = r(7310).URL;
            const { join: n, resolve: s } = r(1017);
            const a = "https://example.com";
            class PathResolver {
                resolve(e, t) {
                    return this.implementation(e, t);
                }
                createStaticResolver(e) {
                    let t = false;
                    try {
                        new i(e);
                        t = true;
                ...
                constructor(e = ""){
                    if (typeof e === "function") {
                        ...
                        this.implementation = this.createStaticResolver(e);
                    }
                }
            }
            e.exports = PathResolver;
        },
        8757: (e, t, r)=>{
            "use strict";
            const { AMP_CACHE_HOST: i, appendRuntimeVersion: n } = r(211);
            function calculateHost(param) {
                let { ampUrlPrefix: e = i, ampRuntimeVersion: t, lts: r = false, rtv: s = false } = param;
                if (r && s) {
        ...
        3167: (e, t, r)=>{
            "use strict";
            const { Parser: i } = r(250);
            const { DomHandler: n, NodeWithChildren: s } = r(945);
            const { appendAll: a } = r(3954);
            const o = r(4404)["default"];
            const c = {
            ...
            e.exports = new TreeParser(c);
            e.exports.TreeParser = TreeParser;
        },
        5664: (e)=>{
            "use strict";
            const isValidImageSrcURL = (e)=>{
                try {
                    return new URL(e, "https://example.com").protocol.startsWith("http");
                } catch (e) {
                    return false;
                }
            };
        ...
        8427: (e, t, r)=>{
            "use strict";
            const { FileSystemCache: i } = r(7315);
            const n = r(1017);
            const s = r(3269);
            const a = i.create({
                log: s,
                baseDir: n.join(("TURBOPACK compile-time value", "/ROOT/node_modules/next/dist/compiled/@ampproject/toolbox-optimizer"), "..", ".cache")
            });
            e.exports = a;
        },
        49: (e, t, r)=>{
            ...
            const i = r(600);
            const n = /^https?:\/\/|^\/\//i;
            function fetchImageDimensions(e) {
                if (n.test(e)) {
                    return fetchImageDimensionsFromUrl(e);
                }
                return fetchImageDimensionsFromFile(e);
            }
            function fetchImageDimensionsFromUrl(e) {
                return probe(e);
            }
            async function fetchImageDimensionsFromFile(e) {
                if (!i("fs")) {
                    throw new Error("No access to the file system");
                }
                const t = r(7147);
                if (!t.existsSync(e)) {
                    throw new Error("Could not resolve file: " + e);
                }
                const n = t.createReadStream(e);
                return probe(n);
            }
            function probe(e) {
        ...
        378: (e, t, r)=>{
            "mode strict";
            const i = "https://raw.githubusercontent.com/ampproject/amphtml/main/build-system/compile/bundles.config.extensions.json";
            const n = r(4934);
            const { MaxAge: s } = r(7315);
            const { AMP_CACHE_HOST: a, AMP_RUNTIME_CSS_PATH: o, AMP_VALIDATION_RULES_URL: c, appendRuntimeVersion: l } = r(211);
            const u = "validator-rules";
            const f = 10 * 60;
            let d = false;
            async function fetchRuntimeParameters(e) {
                let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                const r = Object.assign({}, t);
                r.verbose = t.verbose || e.verbose || false;
                await initRuntimeVersion(r, t, e);
                await initRuntimeStyles(r, e);
                await initValidatorRules(r, t, e);
                return r;
            }
            async function initValidatorRules(e, t, r) {
                try {
                    e.validatorRules = t.validatorRules || r.validatorRules || await fetchValidatorRulesFromCache_(r);
                } catch (e) {
                    r.log.error("Could not fetch validator rules", e);
                }
                try {
                    e.componentVersions = t.componentVersions || r.componentVersions || await fetchComponentVersionsFromCache_(r, e);
                } catch (t) {
                    r.log.error("Could not fetch latest component versions from amp.dev");
                    r.log.verbose(t);
                    e.componentVersions = [];
                }
            }
            async function fetchComponentVersionsFromCache_(e, t) {
                const i = "component-versions-".concat(t.ampRuntimeVersion);
                let n = await readFromCache_(e, i);
                if (!n) {
                    try {
                        n = await fetchComponentVersions_(e, t);
                        writeToCache_(e, i, n);
                    } catch (t) {
                        e.log.warn(t.message);
                        n = r(9503);
                    }
                }
                return n;
            }
            async function fetchComponentVersions_(e, t) {
                const r = t.ampRuntimeVersion.substring(2);
                const n = "https://raw.githubusercontent.com/ampproject/amphtml/".concat(r, "/build-system/compile/bundles.config.extensions.json");
                const s = await e.fetch(n);
                if (!s.ok) {
                    throw new Error("Failed fetching latest component versions from ".concat(i, " with status: ").concat(s.status));
                }
                return s.json();
            }
            async function fetchValidatorRulesFromCache_(e) {
                let t = await readFromCache_(e, "validator-rules");
                let r;
                if (!t) {
                    r = await fetchValidatorRules_(e);
                    e.log.debug("Downloaded AMP validation rules");
                    writeToCache_(e, u, r.raw);
                } else {
                    r = await n.fetch({
                        rules: t
                    });
            ...
            async function fetchValidatorRules_(e) {
                const t = await e.fetch(c);
                if (!t.ok) {
                    return null;
                }
                return n.fetch({
            ...
            async function initRuntimeStyles(e, t) {
                try {
                    e.ampRuntimeStyles = e.ampRuntimeStyles || await fetchAmpRuntimeStyles_(t, e.ampUrlPrefix, e.ampRuntimeVersion);
                } catch (e) {
                    t.log.error("Could not fetch AMP runtime CSS", e);
                }
            }
            async function initRuntimeVersion(e, t, r) {
                e.lts = t.lts || r.lts || false;
                e.rtv = t.rtv || r.rtv || false;
                let { ampUrlPrefix: i, ampRuntimeVersion: n, lts: s } = e;
                if (s && n) {
                    r.log.warn("`ampRuntimeVersion` and `lts` cannot be defined at the same time. Using LTS version.");
                    n = "";
                }
                try {
                    e.ampRuntimeVersion = n || await fetchAmpRuntimeVersion_({
                        config: r,
                        ampUrlPrefix: i,
                        lts: s
                    });
                } catch (e) {
                    r.log.error("Could not fetch latest AMP runtime version", e);
                }
            }
            async function fetchAmpRuntimeVersion_(e) {
                const t = "version-".concat(e.ampUrlPrefix, "-").concat(e.lts);
                let r = await readFromCache_(e.config, t);
                if (!r) {
                    r = await fetchLatestRuntimeData_(e, t);
                    e.config.log.debug("Downloaded AMP runtime v" + r.version);
                } else if (s.fromObject(r.maxAge).isExpired()) {
                    fetchLatestRuntimeData_(t, e);
                }
                return r.version;
            }
            async function fetchLatestRuntimeData_(param) {
                let { config: e, ampUrlPrefix: t, lts: r } = param, i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
                let n;
                n = {
                    version: await e.runtimeVersion.currentVersion({
                        ampUrlPrefix: t,
                        lts: r
                    }),
                    maxAge: s.create(f).toObject()
                };
                if (!n.version && t !== a) {
                    e.log.error("Could not download runtime version from ".concat(t, ". Falling back to ").concat(a));
                    n = await fetchLatestRuntimeData_({
                        config: e,
                        ampUrlPrefix: a,
                        lts: r
                    }, i);
            ...
            async function fetchAmpRuntimeStyles_(e, t, r) {
                if (t && !isAbsoluteUrl_(t)) {
                    e.log.warn("AMP runtime styles cannot be fetched from relative ampUrlPrefix, please use the 'ampRuntimeStyles' parameter to provide the correct runtime style. Falling back to latest v0.css on ".concat(a));
                    t = a;
                    r = r || await e.runtimeVersion.currentVersion();
                }
                const i = l(t || a, r) + o;
                const n = await downloadAmpRuntimeStyles_(e, i);
                if (!n) {
                    e.log.error("Could not download ".concat(i, ". Falling back to latest v0.css."));
                    if (t || r) {
                        return fetchAmpRuntimeStyles_(e, a, await e.runtimeVersion.currentVersion());
                    } else {
                        return "";
                    }
                }
            ...
            async function downloadAmpRuntimeStyles_(e, t) {
                let r;
                if (e.cache !== false) {
                    r = await readFromCache_(e, t);
                }
                if (!r) {
                    ...
                    e.log.debug("Downloaded AMP runtime styles from ".concat(t));
                    if (e.cache !== false) {
                        writeToCache_(e, t, r);
                    }
                }
            ...
            function readFromCache_(e, t) {
                ...
                try {
                    ...
                    if (!d) {
                        e.log.warn("Could not read from cache", t);
                        d = true;
                    }
                }
            }
            function writeToCache_(e, t, r) {
                if (e.cache === false) {
                    return;
                }
                try {
                    ...
                    if (!d) {
                        e.log.warn("Could not write to cache", t);
                        d = true;
                    }
                }
            }
            e.exports = fetchRuntimeParameters;
        },
        8559: (e)=>{
            const t = {
                "&": "\\u0026",
            ...
            const r = /[&><\u2028\u2029]/g;
            e.exports = function htmlEscapeJsonString(e) {
                return e.replace(r, (e)=>t[e]);
            };
        },
        600: (e)=>{
            function isDependencyInstalled(e) {
                try {
                    (()=>{
            ...
            e.exports = isDependencyInstalled;
        },
        3269: (e, t, r)=>{
            "use strict";
            const { log: i } = r(7315);
            e.exports = i.tag("AMP Optimizer");
        },
        7937: (e)=>{
            "use strict";
            let t;
            ...
            const parseSizes = (e)=>{
                ...
                for(let i = 0; i < r.length; i++){
                    const n = r[i];
                    if (i === r.length - 1) {
                        t.defaultValue = n.trim();
                    } else {
                        const r = n.split(/\)\s+/);
                        if (r.length !== 2) {
                            throw new Error("Invalid sizes definition '".concat(e, "'"));
                        }
                        t.values.push({
                            media: "".concat(r[0], ")"),
                            size: r[1]
            ...
            e.exports = parseSizes;
        },
        5136: (e, t, r)=>{
            "use strict";
            const { firstChildByTag: i, createElement: n, appendChild: s } = r(3954);
            class AddAmpLink {
                transform(e, t) {
                    if (!t.ampUrl) return;
                    const r = i(e, "html");
            ...
            e.exports = AddAmpLink;
        },
        6686: (e, t, r)=>{
            const i = r(600);
            const { createElement: n, appendChild: s, nextNode: a, firstChildByTag: o } = r(3954);
            const { URL: c } = r(7310);
            const { skipNodeAndChildren: l } = r(1764);
            const u = r(5470);
            const f = 60;
            const d = 100;
            const p = 30;
            const h = -1;
            const { isTemplate: m } = r(211);
            const g = {
                "#": "%23",
                "%": "%25",
                ":": "%3A",
            ...
            const b = new RegExp(Object.keys(g).join("|"), "g");
            function escaper(e) {
                return g[e];
            }
            class AddBlurryImagePlaceholders {
                transform(e, t) {
                    if (!t.blurredPlaceholders && !this.blurredPlaceholders_ || this.missingDependencies_) {
                        return;
                    }
                    const r = o(e, "html");
                    const i = o(r, "body");
                    ...
                    for(let e = i; e !== null; e = a(e)){
                        ...
                        if (r === "amp-video" && e.attribs.poster) {
                            i = e.attribs.poster;
                        }
                        if (this.shouldAddBlurryPlaceholder_(e, i, r)) {
                            c++;
                            const r = this.addBlurryPlaceholder_(i, t).then((t)=>{
                                e.attribs["i-amphtml-ssr"] = "";
                                e.attribs.noloading = "";
                                s(e, t);
                            });
                            n.push(r);
                            if (c >= this.maxBlurredPlaceholders_) {
                                break;
                            }
                        }
                    }
                ...
                async addBlurryPlaceholder_(e, t) {
                    const r = n("img", {
                    ...
                    try {
                        const i = await this.getCachedDataURI(e, t);
                        let n = '<svg xmlns="http://www.w3.org/2000/svg"\n                      xmlns:xlink="http://www.w3.org/1999/xlink"\n                      viewBox="0 0 '.concat(i.width, " ").concat(i.height, '">\n                      <filter id="b" color-interpolation-filters="sRGB">\n                        <feGaussianBlur stdDeviation=".5"></feGaussianBlur>\n                        <feComponentTransfer>\n                          <feFuncA type="discrete" tableValues="1 1"></feFuncA>\n                        </feComponentTransfer>\n                      </filter>\n                      <image filter="url(#b)" x="0" y="0"\n                        height="100%" width="100%"\n                        xlink:href="').concat(i.src, '">\n                      </image>\n                    </svg>');
                        n = n.replace(/\s+/g, " ");
                        n = n.replace(/> </g, "><");
                        n = n.replace(b, escaper);
                        r.attribs.src = "data:image/svg+xml;charset=utf-8," + n;
                        this.log_.debug(e, "[SUCCESS]");
                    } catch (t) {
                        this.log_.debug(e, "[FAIL]");
                        this.log_.error(t.message);
                    }
                    return r;
                }
                getCachedDataURI(e, t) {
                    const r = this.pathResolver_.resolve(e, t);
                    if (this.cache_) {
                        const t = this.cache_.get(r);
                        if (t) {
                            this.log_.debug(e, "[CACHE HIT]");
                            return t;
                        }
                        this.log_.debug(e, "[CACHE MISS]");
                    }
                ...
                async getDataURI_(e) {
                    ...
                    const r = await this.jimp.read(t);
                    const i = this.getBitmapDimensions_(r.bitmap.width, r.bitmap.height);
                    r.resize(i.width, i.height, this.jimp.RESIZE_BEZIER);
                    const n = {
                        src: await r.getBase64Async("image/png"),
                        width: i.width,
                        height: i.height
                    };
                    return n;
                }
                getBitmapDimensions_(e, t) {
                    const r = e / t;
                    let i = f / r;
                    i = Math.sqrt(i);
                    const n = f / i;
                ...
                hasPlaceholder_(e) {
                    return e.childNodes.find((e)=>e.attribs && e.attribs.placeholder !== undefined) !== undefined;
                }
                shouldAddBlurryPlaceholder_(e, t, r) {
                    if (!t) {
                        return false;
                    }
                    if (this.hasPlaceholder_(e)) {
                        return false;
                    }
                    const i = new c(t, "https://example.com");
                    if (!i.pathname.endsWith(".jpg") && !i.pathname.endsWith("jpeg")) {
                        return false;
                    }
                    if (e.attribs.noloading != null) {
                        return false;
                    }
                    const n = r == "amp-video";
                    const s = r == "amp-img" && (e.attribs.layout == "intrinsic" || e.attribs.layout == "responsive" || e.attribs.layout == "fill");
                    return n || s;
                }
                constructor(e){
                    this.log_ = e.log.tag("AddBlurryImagePlaceholders");
                    this.blurredPlaceholders_ = !!e.blurredPlaceholders;
                    ...
                    this.jimp = r(4645);
                    this.maxBlurredPlaceholders_ = e.maxBlurredPlaceholders || d;
                    this.pathResolver_ = new u(e.imageBasePath);
                    const t = e.blurredPlaceholdersCacheSize || p;
                    if (t === h) {
                        this.log_.debug("caching all placeholders");
                        this.cache_ = new Map;
                    } else if (t > 0) {
                        const e = r(7330);
                        this.log_.debug("using LRU cache for regularily used placeholders", t);
                        this.cache_ = new e({
                            max: t
                        });
                    } else {
            ...
            e.exports = AddBlurryImagePlaceholders;
        },
        2337: (e, t, r)=>{
            "use strict";
            const { move: i, insertText: n, appendChild: s, insertBefore: a, createDocType: o, createElement: c, firstChildByTag: l } = r(3954);
            const { AMP_FORMATS: u, AMP_TAGS: f } = r(211);
            const d = "AMP";
            const p = "data-auto";
            const h = {
                AMP: [
                    ...
                    },
                    {
                        ...
                        node: {
                            ...
                            attribs: {
                                ...
                                href: (e, t)=>{
                                    if (!e.canonical) {
                                        t.warn("No canonical param is given. Setting canonical href to `.`");
                                        e.canonical = ".";
                                    }
                                    return e.canonical;
                                }
            ...
            class AddMandatoryTags {
                async transform(e, t) {
                    ...
                    let i = l(e, "html");
                    if (!i) {
                        i = this.createHtml5Document(e);
                    }
                    let n = e.children.find((e)=>e.type === "directive" && e.name === "!doctype");
                    if (!n) {
                        n = o();
                        a(e, n, e.firstChild);
                    }
                    if (!Object.keys(i.attribs).some((e)=>f.includes(e))) {
                ...
                matchSpec(e, t) {
                    ...
                    for (const [r, i] of Object.entries(e.attribs)){
                        const e = t.attribs[r];
                ...
                addNode(e, t, r) {
                    const i = {};
                    i[p] = "";
                    const n = c(t.tagName, i);
                    this.addAttributes(t, n, r);
                    this.addChildren(t, n, r);
                    this.addText(t, n, r);
                    s(e, n);
                }
                addText(e, t, r) {
                ...
                addAttributes(e, t, r) {
                    ...
                    for (const [i, n] of Object.entries(e.attribs)){
                        if (typeof n === "function") {
                            t.attribs[i] = n(r, this.log_);
                        } else {
                            t.attribs[i] = n;
                        }
                    }
                }
                createHtml5Document(e) {
                    const t = c("html", {});
                    const r = this.createOrMoveElement(e, t, "head");
                    const i = this.createOrMoveElement(e, t, "body");
                    this.copyTagsToHeadAndBody(e, r, i);
                    s(e, t);
                    return t;
                }
                createOrMoveElement(e, t, r) {
                    const n = l(e, r) || c(r);
                    i(n, t);
                    return n;
                }
                copyTagsToHeadAndBody(e, t, r) {
                    let n = e.firstChild;
                    while(n){
                        const e = n;
                        n = e.next;
                        if (e.type === "directive") {} else if (e.tagName === "title") {
                            i(e, t);
                        } else {
                            i(e, r);
                        }
                ...
                constructor(e){
                    this.enabled = e.autoAddBoilerplate !== false && e.autoAddMandatoryTags !== false;
                    this.format = e.format || d;
                    this.log_ = e.log.tag("AddMandatoryTags");
                }
            }
            e.exports = AddMandatoryTags;
        },
        5338: (e, t, r)=>{
            "use strict";
            const { firstChildByTag: i } = r(3954);
            class AddTransformedFlag {
                transform(e) {
                    const t = i(e, "html");
                    if (!t) return;
                    t.attribs.transformed = "self;v=1";
                }
            }
            e.exports = AddTransformedFlag;
        },
        6716: (e, t, r)=>{
            "use strict";
            const { appendChild: i, createElement: n, hasAttribute: s, firstChildByTag: a, insertText: o } = r(3954);
            const c = "document.querySelector(\"script[src*='/v0.js']\").onerror=function(){" + "document.querySelector('style[amp-boilerplate]').textContent=''}";
            const l = "[].slice.call(document.querySelectorAll(" + "\"script[src*='/v0.js'],script[src*='/v0.mjs']\")).forEach(" + "function(s){s.onerror=" + "function(){" + "document.querySelector('style[amp-boilerplate]').textContent=''" + "}})";
            class AmpBoilerplateErrorHandler {
                transform(e, t) {
                    ...
                    if (s(r, "i-amphtml-no-boilerplate")) {
                        return;
                    }
                    const u = a(r, "head");
                    if (!u) {
            ...
            e.exports = AmpBoilerplateErrorHandler;
        },
        4039: (e, t, r)=>{
            "use strict";
            const { insertText: i, hasAttribute: n, firstChildByTag: s } = r(3954);
            class AmpBoilerplateTransformer {
                transform(e, t) {
                    ...
                    const a = this._findAmpRuntimeStyle(n);
                    if (!a) {
                        return;
                    }
                    let { ampRuntimeVersion: o, ampRuntimeStyles: c } = t;
                    if (!o || !c) {
                ...
                constructor(e){
                    this.fetch_ = e.fetch;
                    this.runtimeVersion_ = e.runtimeVersion;
                    this.log_ = e.log.tag("AmpBoilerplateTransformer");
                }
            }
            e.exports = AmpBoilerplateTransformer;
        },
        2419: (e, t, r)=>{
            "use strict";
            const { remove: i, appendChild: n, createElement: s, nextNode: a, firstChildByTag: o } = r(3954);
            const { calculateHash: c } = r(9874);
            class AmpScriptCsp {
                transform(e) {
                    const t = o(e, "html");
                    if (!t) return;
                    ...
                    const n = o(t, "body");
                    if (!n) return;
                    const s = this._findOrCreateCspMeta(r);
                    const a = (s.attribs.content || "").trim().split(/\s+/);
                    const l = new Set(a);
                    l.delete("");
                    const u = this._findAllInlineScripts(n);
                    for (const e of u){
                        const t = e.children[0] ? e.children[0].data : "";
                        l.add(c(t));
                    }
                    const f = Array.from(l).join(" ");
                    if (f === "") {
                        i(s);
                        return;
                    }
                ...
                _findOrCreateCspMeta(e) {
                    for(let t = e.firstChild; t !== null; t = t.nextSibling){
                        if (t.tagName === "meta" && t.attribs.name === "amp-script-src") {
                            return t;
                        }
                    }
                    const t = s("meta", {
            ...
            e.exports = AmpScriptCsp;
        },
        1033: (e, t, r)=>{
            "use strict";
            const i = r(7937);
            const { appendChild: n, createElement: s, insertText: a, hasAttribute: o } = r(3954);
            const { isCustomElement: c } = r(3585);
            const l = "i-amp-";
            class MediaTransformer {
                transform(e, t) {
                    let r = e.attribs.media.replace(/\s+/g, " ");
                    r = r.trim();
                    if (!r) {
                        return false;
                    }
                    ...
                    this.addMedia(r, "#".concat(t));
                    return true;
                }
                addMedia(e, t) {
                    let r = this.media.get(e);
                    if (!r) {
                        r = [];
                        this.media.set(e, r);
                    }
                ...
                toString() {
                    let e = "";
                    for (const [t, r] of this.media.entries()){
                        e += "@media ".concat(t, "{").concat(r.join(","), "{display:none}}");
                    }
                    return e;
                }
                constructor(){
            ...
            class SizesTransformer {
                ...
                addSizes(e, t) {
                    this.sizes.push({
                        id: e,
                        defaultSize: t.defaultValue,
                        sizes: t.values.reverse()
                    });
                }
                toString() {
                    let e = "";
                    for (const { sizes: t, defaultSize: r, id: i } of this.sizes){
                        const n = "#".concat(i);
                        e += "".concat(n, "{width:").concat(r, "}");
                        for (const r of t){
                            e += "@media ".concat(r.media, "{").concat(n, "{width:").concat(r.size, "}}");
                        }
                    }
                    return e;
                }
            ...
            class HeightsTransformer {
                ...
                addHeights(e, t) {
                    this.heights.push({
                        id: e,
                        defaultHeight: t.defaultValue,
                        heights: t.values.reverse()
                    });
                }
                toString() {
                    let e = "";
                    for (const { heights: t, defaultHeight: r, id: i } of this.heights){
                        const n = "#".concat(i, ">:first-child");
                        e += "".concat(n, "{padding-top:").concat(r, "}");
                        for (const r of t){
                            e += "@media ".concat(r.media, "{").concat(n, "{padding-top:").concat(r.size, "}}");
                        }
                    }
                    return e;
                }
            ...
            class ApplyCommonAttributes {
                addNode(e) {
                    ...
                    if (o(e, "id")) {
                        this.ids.add(e.attribs.id);
                    }
                    if (c(e)) {
                        this.nodesToTransform.push(e);
                    }
                }
                apply() {
                    for (const e of this.nodesToTransform){
                        const t = this.getOrCreateId(e);
                        let r = false;
                        for (const [i, n] of Object.entries(this.attributeTransformations)){
                            if (o(e, i)) {
                                try {
                                    r = r || n.transform(e, t);
                                } catch (t) {
                                    this.log.debug("Cannot remove boilerplate. Failed transforming ".concat(i, '="').concat(e.attribs[i], '".'), t);
                ...
                applyToCustomStyles(e, t) {
                    ...
                    t.children[0].data += r;
                    for (const e of this.nodesToTransform){
                        for (const t of Object.keys(this.attributeTransformations)){
                            delete e.attribs[t];
                        }
                    }
                }
                getOrCreateId(e) {
                    ...
                    e.attribs = e.attribs || [];
                    const t = l + this.transformedNodesCounter;
                    this.transformedNodesCounter++;
                    if (this.ids.has(t)) {
                        return this.getOrCreateId(e);
                    }
                    return t;
                }
                constructor(e){
            ...
            e.exports = ApplyCommonAttributes;
        },
        9112: (e, t, r)=>{
            "use strict";
            const { hasAttribute: i, insertBefore: n, createElement: s, appendChild: a } = r(3954);
            const { parseLayout: o, cssLength: c, calculateHeight: l, calculateWidth: u, calculateLayout: f, getLayoutClass: d, isLayoutSizeDefined: p, getLayoutSizeDefinedClass: h } = r(2335);
            const m = [
                "",
                "nodisplay",
                "fixed",
            ...
            function isSupportedLayout(e) {
                return m.indexOf(e) > -1;
            }
            function getAttributeOrNull(e, t) {
                return i(e, t) ? e.attribs[t] : null;
            }
            function addClass(e, t) {
                const r = i(e, "class") ? e.attribs.class.trim() : "";
                e.attribs.class = r.length > 0 ? r + " " + t : t;
            }
            function apply(e, t, r, i) {
                addClass(i, d(e));
                if (p(e)) {
                    addClass(i, h());
                }
                ...
                switch(e){
                    case "nodisplay":
                        ...
                        break;
                    case "fixed":
                        n = "width:".concat(t.numeral).concat(t.unit, ";height:").concat(r.numeral).concat(r.unit, ";");
                        break;
                    case "fixed-height":
                        n = "height:".concat(r.numeral).concat(r.unit, ";");
                        break;
                    case "responsive":
                        break;
                    case "intrinsic":
                    ...
                    case "container":
                        break;
                    case "fluid":
                        n = "width:100%;height:0;";
                        addClass(i, "i-amphtml-layout-awaiting-size");
                        break;
                    case "flex-item":
                        if (t.isSet) {
                            n = "width:".concat(t.numeral).concat(t.unit, ";");
                        }
                        if (r.isSet) {
                            n += "height:".concat(r.numeral).concat(r.unit, ";");
                        }
                ...
                i.attribs.style = n + (i.attribs.style ? i.attribs.style : "");
                if (i.attribs.style === "") {
                    delete i.attribs.style;
                }
                i.attribs["i-amphtml-layout"] = e;
            }
            function maybeAddSizerInto(e, t, r, i) {
                if (!r.isSet || r.numeral === 0 || !i.isSet || r.unit !== i.unit) {
                    return;
                }
                let s = null;
                if (t === "responsive") {
                    s = createResponsiveSizer(r, i);
                } else if (t === "intrinsic") {
                    s = createIntrinsicSizer(r, i);
                }
                if (s) {
                    const t = e.firstChild;
                    n(e, s, t);
            ...
            function createResponsiveSizer(e, t) {
                const r = t.numeral / e.numeral * 100;
                const i = s("i-amphtml-sizer", {
                    style: "display:block;padding-top:".concat(parseFloat(r.toFixed(4)), "%")
                });
                return i;
            }
            function createIntrinsicSizer(e, t) {
                const r = s("i-amphtml-sizer", {
                ...
                const i = s("img", {
                    ...
                    role: "presentation",
                    src: "data:image/svg+xml;base64," + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from('<svg height="'.concat(t.numeral, '" width="').concat(e.numeral, '" xmlns="http://www.w3.org/2000/svg" version="1.1"/>')).toString("base64")
                });
                a(r, i);
                return r;
            }
            e.exports = {
                applyLayout: function(e, t) {
                    const r = o(e.attribs.layout);
                    const i = getAttributeOrNull(e, "width");
                    const n = c(i, true, false);
                    if (!n.isValid) {
                        t.debug("cannot perform SSR: invalid input width\n", i);
                        return false;
                    }
                    const s = getAttributeOrNull(e, "height");
                    const a = c(s, true, r === "fluid");
                    if (!a.isValid) {
                        t.debug("cannot perform SSR: invalid input height\n", s);
                        return false;
                    }
                    const d = l(r, a, e.tagName);
                    const p = u(r, n, e.tagName);
                    const h = f(r, p, d, getAttributeOrNull(e, "sizes"), getAttributeOrNull(e, "heights"));
                    if (!isSupportedLayout(h)) {
                        t.debug("cannot perform SSR: unsupported layout", h);
                        return false;
                    }
                    if (h && h === "responsive") {
                        e.attribs.layout = h;
        ...
        898: (e, t, r)=>{
            "use strict";
            const { nextNode: i, insertAfter: n, createElement: s, firstChildByTag: a, hasAttribute: o } = r(3954);
            const { findMetaViewport: c, findRuntimeScript: l } = r(1764);
            const { AMP_FORMATS: u, AMP_CACHE_HOST: f } = r(211);
            const d = "bind";
            const p = "data-amp-bind-";
            const h = "AMP";
            const m = new Map([
                [
                    "lightbox",
            ...
            class AutoExtensionImporter {
                createExtensionsSpec(e) {
                    const t = e.validatorRules;
                    const r = new Map;
                    for (const e of t.extensions){
                        if (e.htmlFormat.includes(this.format)) {
                            r.set(e.name, {
                                name: e.name,
                                type: e.extensionType === "CUSTOM_TEMPLATE" ? "custom-template" : "custom-element",
                                version: e.version.filter((e)=>e !== "latest")
                            });
                        }
                    }
                    const i = new Map;
                    const n = new Map;
                    const s = new Map;
                    for (const e of t.getTagsForFormat(this.format)){
                        const t = e.tagName.toLowerCase();
                        if (t.startsWith("amp-")) {
                            let r = e.requiresExtension || [];
                            r = r.filter((e)=>!g.includes(e));
                            i.set(t, r);
                        }
                        const r = new Set;
                        for (const i of e.attrs){
                            if (m.has(i.name)) {
                                i.requiresExtension = [
                                    m.get(i.name)
                                ];
                    ...
                    return {
                        ...
                        tagToAttributeMapping: n,
                        tagToBindAttributeMapping: s
                    };
                }
                async transform(e, t) {
                    if (!this.enabled) {
                    ...
                    if (!this.componentVersions) {
                        ...
                        for (const e of t.componentVersions){
                            this.componentVersions[e.name] = e.latestVersion;
                        }
                    }
                    if (!this.extensionSpec_) {
                        this.extensionSpec_ = this.createExtensionsSpec(t);
                    }
                    if (!u.includes(this.format)) {
                    ...
                    const d = new Set;
                    const p = new Set;
                    this.findExistingExtensionsAndExtensionsToImportInHead_(i, d, p);
                    await this.findExtensionsToImportInBody_(o, d);
                    if (d.length === 0) {
                        return;
                    }
                    let h = l(i);
                    ...
                    for (const e of d){
                        ...
                        const t = this.extensionSpec_.extensionsMap.get(e.trim());
                        this.log_.debug("auto importing", e);
                        let r = this.calculateVersion(t, e);
                        const a = {
                            async: "",
                            src: "".concat(m, "/v0/").concat(e, "-").concat(r, ".js")
                        };
                        a[t.type] = e;
                        const o = s("script", a);
                        n(i, o, h);
                ...
                calculateVersion(e, t) {
                    const r = this.extensionVersions[t];
                    if (r) {
                        this.log_.debug("using custom version for", t, r);
                        return r;
                    }
                    const i = this.componentVersions[t];
                    const n = e.version[e.version.length - 1];
                    if (n < i) {
                        return n;
                    }
                    return i;
                }
                findExistingExtensionsAndExtensionsToImportInHead_(e, t, r) {
                    let n = e;
                    while(n){
                        const e = this.getCustomElement_(n);
                        if (e) {
                            r.add(e);
                        } else if (n.tagName === "script" && n.attribs["id"] === "amp-access") {
                            t.add("amp-access");
                            t.add("amp-analytics");
                            const e = this.getJson(n);
                            if (e.vendor === "laterpay") {
                                t.add("amp-access-laterpay");
                            }
                        } else if (n.tagName === "script" && n.attribs["id"] === "amp-subscriptions") {
                            ...
                            if (e.services && e.services.length) {
                                for (const r of e.services){
                                    if (r.serviceId === "subscribe.google.com") {
                                        t.add("amp-subscriptions-google");
                                    }
                                }
                            }
                        }
                ...
                getJson(e) {
                    for (const t of e.children || []){
                        ...
                        try {
                            ...
                            this.log_.error('Could not parse JSON in <script id="amp-access">', e.message);
                        }
                    }
                    return {};
                }
                async findExtensionsToImportInBody_(e, t) {
                    let r = e;
                    while(r !== null){
                        if (r.tagName) {
                            this.addRequiredExtensionByTag_(r, t);
                            this.addRequiredExtensionByAttributes_(r, t);
                        }
                        r = i(r);
                    }
                }
                addRequiredExtensionByTag_(e, t) {
                    const r = this.extensionSpec_.tagToExtensionsMapping.get(e.tagName);
                    if (r) {
                        r.forEach((e)=>t.add(e));
                    }
                    if (e.tagName === "template" && e.attribs.type) {
                        t.add(e.attribs.type);
                    } else if (e.tagName === "script" && o(e, "template")) {
                        t.add(e.attribs.template);
                    } else if (e.tagName === "input" && o(e, "mask")) {
                        t.add("amp-inputmask");
                    }
                }
                addRequiredExtensionByAttributes_(e, t) {
                    if (!e.tagName || !e.attribs) {
                        return;
                    }
                    const r = this.extensionSpec_.tagToAttributeMapping;
                    const i = r.get(e.tagName) || [];
                    i.forEach((r)=>{
                        if (e.attribs[r.name] !== undefined) {
                            r.requiresExtension.forEach((e)=>{
                                t.add(e);
                            });
                        }
                    });
                    ...
                    const n = this.extensionSpec_.tagToBindAttributeMapping;
                    const s = Object.keys(e.attribs);
                    if (s.some((e)=>e.startsWith("[") || e.startsWith(p))) {
                        t.add("amp-bind");
                    }
                    if (this.experimentBindAttributeEnabled) {
                        const r = n.get(e.tagName);
                        let i = false;
                        for (const n of s){
                            if (!n.startsWith(d)) {
                                continue;
                            }
                            const s = n.substring(d.length);
                            if (r.has(s)) {
                                const t = "".concat(p).concat(s);
                                e.attribs[t] = e.attribs[n];
                                delete e.attribs[n];
                                i = true;
                            }
                            if (i) {
                ...
                constructor(e){
                    this.enabled = e.autoExtensionImport !== false;
                    this.format = e.format || h;
                    this.log_ = e.log.tag("AutoExtensionImporter");
                    this.experimentBindAttributeEnabled = e.experimentBindAttribute === true;
                    this.extensionVersions = e.extensionVersions || {};
                }
            }
            e.exports = AutoExtensionImporter;
        },
        312: (e, t, r)=>{
            "use strict";
            const { insertAfter: i, createElement: n, firstChildByTag: s } = r(3954);
            const { findMetaViewport: a } = r(1764);
            class GoogleFontsPreconnect {
                transform(e) {
                    ...
                    for(let e = r.firstChild; e !== null; e = e.nextSibling){
                        if (this.isGoogleFontsLinkNode_(e)) {
                            const e = n("link", {
                                rel: "preconnect",
                            ...
                            const s = a(r);
                            i(r, e, s);
                            this.log_.debug('adding <link rel="preconnect" href="' + e.attribs.href + '" crossorigin>');
                            i(r, t, e);
                            this.log_.debug('adding <link rel="dns-prefetch" href="' + t.attribs.href + '">');
                            return;
                        }
                    }
                }
                isGoogleFontsLinkNode_(e) {
                    return e.tagName === "link" && e.attribs.rel === "stylesheet" && e.attribs.href.startsWith("https://fonts.googleapis.com");
                }
                constructor(e){
                    this.log_ = e.log.tag("GoogleFontsPreconnect");
                }
            }
            e.exports = GoogleFontsPreconnect;
        },
        2246: (e, t, r)=>{
            "use strict";
            const i = r(5470);
            const { fetchImageDimensions: n } = r(49);
            const { remove: s, insertAfter: a, createElement: o, firstChildByTag: c, nextNode: l } = r(3954);
            const u = "intrinsic";
            const f = 320;
            class Markdown {
                async transform(e, t) {
                    ...
                    while(n){
                        const e = l(n);
                        if (n.tagName === "img") {
                            s.push(this.transformImg(n, t));
                        }
                        n = e;
                    }
                    return Promise.all(s);
                }
                async transformImg(e, t) {
                    const r = e.attribs && e.attribs.src;
                    if (!r) {
                        return;
                    }
                    const i = this.pathResolver.resolve(r, t);
                    let o;
                    try {
                        o = await n(i);
                    } catch (e) {
                    ...
                    const c = this.createAmpImgOrAmpAnim(o, e);
                    a(e.parent, c, e);
                    s(e);
                }
                createAmpImgOrAmpAnim(e, t) {
                    const r = e.type === "gif" ? "amp-anim" : "amp-img";
                    const i = o(r, t.attribs);
                    i.attribs.width = t.attribs.width || String(e.width);
                    i.attribs.height = t.attribs.height || String(e.height);
                    this.addLayout(i, e);
                    return i;
                }
                addLayout(e, t) {
                ...
                constructor(e){
                    this.log = e.log;
                    this.enabled = !!e.markdown;
                    this.pathResolver = new i(e.imageBasePath);
                }
            }
            e.exports = Markdown;
        },
        7248: (e, t, r)=>{
            "use strict";
            const { minify: i } = r(6794);
            const { remove: n } = r(3954);
            const s = r(5438);
            const a = r(8559);
            ...
            class MinifyHtml {
                async transform(e) {
                    ...
                    const t = [];
                    await this.minifyNode(e, this.opts, t);
                    for (const e of t){
                        n(e);
                    }
                }
                async minifyNode(e, t, r) {
                    if (e.type === "text") {
                        this.minifyTextNode(e, t, r);
                    } else if (e.type === "comment") {
                        this.minifyCommentNode(e, t, r);
                    } else if (e.tagName === "script") {
                        await this.minifyScriptNode(e, t);
                    }
                    const i = Object.assign({}, t);
                    if (t.canCollapseWhitespace && !this.canCollapseWhitespace(e.tagName)) {
                        i.canCollapseWhitespace = false;
                    }
                    if (e.tagName === "head" || e.tagName === "html") {
                        i.inBody = false;
                    ...
                    const n = [];
                    for (const t of e.children || []){
                        n.push(this.minifyNode(t, i, r));
                    }
                    return Promise.all(n);
                }
                minifyTextNode(e, t, r) {
                    if (!e.data || !t.collapseWhitespace) {
                        return;
                    }
                    if (t.canCollapseWhitespace) {
                        e.data = s(e.data);
                    }
                    if (!t.inBody) {
                        e.data = e.data.trim();
                ...
                minifyCommentNode(e, t, r) {
                    if (!e.data || !t.removeComments) {
                        return;
                    }
                    if (t.commentIgnorePattern.test(e.data)) {
                        return;
                    }
                    r.push(e);
                }
                async minifyScriptNode(e, t) {
                    const r = this.isJson(e);
                    const i = !r && this.isInlineAmpScript(e);
                    for (const n of e.children || []){
                        ...
                        if (r && t.minifyJSON) {
                            this.minifyJson(n);
                        } else if (i && t.minifyAmpScript) {
                            await this.minifyAmpScript(n);
                        }
                    }
                }
                async minifyAmpScript(e) {
                    try {
                        const t = await i(e.data, {});
                        if (t.error) {
                            this.log.warn("Could not minify inline amp-script", e.data, "".concat(t.error.name, ": ").concat(t.error.message));
                            return;
                        }
                        e.data = t.code;
                    } catch (e) {
                ...
                minifyJson(e) {
                    try {
                        let t = JSON.stringify(JSON.parse(e.data), null, "");
                        t = a(t);
                        e.data = t;
                    } catch (t) {
                        this.log.warn("Invalid JSON", e.data);
                    }
                }
                isInlineAmpScript(e) {
                    return e.attribs && e.attribs.type === "text/plain" && e.attribs.target === "amp-script";
                }
                isJson(e) {
                    return e.attribs && (e.attribs.type === "application/json" || e.attribs.type === "application/ld+json");
                }
                canCollapseWhitespace(e) {
                    return "script" !== e && "style" !== e && "pre" !== e && "textarea" !== e;
                }
                canTrimWhitespace(e) {
                    return e !== "pre" && e !== "textarea";
                }
                constructor(e){
                    this.opts = {
                        minify: e.minify !== false,
                    ...
                    this.log = e.log.tag("MinifyHtml");
                }
            }
            e.exports = MinifyHtml;
        },
        5552: (e, t, r)=>{
            const { nextNode: i, firstChildByTag: n, setAttribute: s } = r(3954);
            const { skipNodeAndChildren: a } = r(1764);
            const { isTemplate: o } = r(211);
            class OptimizeAmpBind {
                transform(e) {
                    ...
                    s(t, "i-amphtml-binding", "");
                    for(let e = t; e !== null; e = i(e)){
                        if (o(e)) {
                            e = a(e);
                            if (e === null) {
                                break;
                        ...
                        if (!t) continue;
                        for(const r in t){
                            if (r.startsWith("data-amp-bind-") || r.startsWith("[") && r.endsWith("]")) {
                                s(e, "i-amphtml-binding", "");
                                break;
                            }
                        }
                    }
                ...
                constructor(e){
                    this.log_ = e.log.tag("OptimizeAmpBind");
                    this.enabled_ = e.optimizeAmpBind !== false;
                    if (!this.enabled_) {
                        this.log_.debug("disabled");
                    }
                }
            }
            function hasAmpBindScriptNode(e) {
                for(let t = e.firstChild; t !== null; t = t.nextSibling){
                    if (t.tagName !== "script") continue;
                    if (!t.attribs) continue;
                    if (t.attribs["custom-element"] !== "amp-bind") continue;
                    return true;
                }
                return false;
            }
            e.exports = OptimizeAmpBind;
        },
        5661: (e, t, r)=>{
            "use strict";
            const { appendChild: i, createElement: n, hasAttribute: s, remove: a, insertAfter: o, nextNode: c, firstChildByTag: l } = r(3954);
            const { findMetaViewport: u, skipNodeAndChildren: f } = r(1764);
            const { isValidImageSrcURL: d } = r(5664);
            const { isTemplate: p, isAmpStory: h } = r(211);
            const m = 150;
            const g = 2;
            class OptimizeHeroImage {
                async transform(e, t) {
                    if (t.preloadHeroImage) {
                        this.log.info("`preloadHeroImage` option has been deprecated. Use `optimizeHeroImages` instead");
                    }
                    if (!this.enabled || t.optimizeHeroImages === false || t.preloadHeroImage === false) {
                        return;
                    }
                    const r = t.maxHeroImageCount || this.maxHeroImageCount;
                    const i = l(e, "html");
                    const n = l(i, "head");
                    const s = l(i, "body");
                    if (!s || !n) return;
                    const a = this.findHeroImages(s);
                    let o = u(n);
                    let c = a.length;
                    if (c > r) {
                        this.log.warn("Found ".concat(c, " hero elements on the page, but the maximum is set to ").concat(r, ". The limit can be configured via the 'maxHeroImage' parameter."));
                        c = r;
                    }
                    const f = h(n);
                    for(let e = 0; e < c; e++){
                        const t = a[e];
                        this.generatePreload(t, n, o);
                        if (!f) {
                            this.generateImg(t.ampImg);
                        }
                    }
                }
                generatePreload(e, t, r) {
                    if (e.srcset) {
                        this.log.debug("Could not preload hero image as it's using srcset, which is currently only supported Chromium-based browsers (see https://web.dev/preload-responsive-images/).", e.src);
                        return;
                    }
                    if (this.hasExistingImagePreload(t, e.src)) {
                        return;
                    }
                    const i = n("link", {
                        rel: "preload",
                    ...
                    i.attribs.media = e.media;
                    o(t, i, r);
                }
                hasExistingImagePreload(e, t) {
                    return e.children.some((e)=>{
                        ...
                        if (e.attribs.rel !== "preload") {
                            return false;
                        }
                        if (e.attribs.as !== "image") {
                            return false;
                        }
                        return e.attribs.href === t;
                    });
                }
                findHeroImages(e) {
                    let t = null;
                ...
                addImageWithDataHero(e, t) {
                    if (e.tagName === "amp-img" && s(e, "data-hero")) {
                        const { src: r, media: i, srcset: n } = e.attribs;
                        t.push({
                            ampImg: e,
                            src: r,
                            media: i,
                    ...
                    } else if (this.isAmpIframe(e) && s(e, "data-hero")) {
                        const r = this.getPlaceholderImage(e);
                        if (r) {
                            t.push(r);
                        }
                    }
                }
                isCandidateHeroImage(e) {
                    if (!e.tagName) {
                        return null;
                    }
                    const t = e.attribs ? e.attribs.layout : "";
                    if (t === "nodisplay") {
                        return null;
                    }
                    if (e.tagName === "amp-img") {
                        return this.isCandidateImageForPreloading(e);
                    }
                    if (e.tagName === "amp-video") {
                        return this.isCandidateVideoPosterImage(e);
                    }
                    if (this.isAmpIframe(e)) {
                        return this.isCandidateIframePlaceholderImage(e);
                    }
                    return null;
                }
                isAmpIframe(e) {
                    return e.tagName === "amp-iframe" || e.tagName === "amp-video-iframe";
                }
                isCandidateVideoPosterImage(e) {
                    const t = e.attribs.poster;
                    if (!t) return null;
                    if (!d(t)) {
                        return null;
                    }
                    const { layout: r, width: i, height: n, media: s } = e.attribs;
                    if (this.isTinyNode(r, i, n)) {
                        return null;
                    }
                    return {
                        src: t,
                ...
                isCandidateIframePlaceholderImage(e) {
                    if (!e.children || e.children.length === 0) {
                        return null;
                    }
                    const { layout: t, width: r, height: i } = e.attribs;
                    if (this.isTinyNode(t, r, i)) return null;
                    return this.getPlaceholderImage(e);
                }
                getPlaceholderImage(e) {
                    for (const t of e.children){
                        if (t.tagName === "amp-img" && s(t, "placeholder") && d(t.attribs.src)) {
                            return {
                                ampImg: t,
                                src: t.attribs.src,
                                media: e.attribs.media,
                                srcset: t.attribs.srcset || ""
                            };
                        }
                    }
                    return null;
                }
                isCandidateImageForPreloading(e) {
                    const t = e.attribs.src;
                    if (!t) {
                        return null;
                    }
                    if (!d(t)) {
                    ...
                    let { width: r, height: i, srcset: n, layout: s, media: a } = e.attribs;
                    if (!r && !i) {
                        if (s === "fill") {
                            ({ width: r, height: i } = this.nodeDimensionsFromParent(e));
                        } else {
                            return null;
                        }
                    }
                    if (this.isTinyNode(s, r, i)) {
                        return null;
                    }
                    return {
                        ampImg: e,
                ...
                nodeDimensionsFromParent(e) {
                    while(e.parent){
                        e = e.parent;
                        if (!e.attribs) {
                            continue;
                        }
                        const t = e.attribs.width;
                        const r = e.attribs.height;
                        if (!t && !r) {
                            continue;
                        }
                        return {
                ...
                generateImg(e) {
                    ...
                    const r = this.getNoscriptFallbackImage(e);
                    if (r) {
                        if (s(r, "loading")) {
                            t.attribs.loading = r.attribs.loading;
                        }
                        a(r.parent);
                    } else if (!this.isMarkedAsHeroImage(e)) {
                        t.attribs["loading"] = "lazy";
                    }
                    if (!s(e.attribs, "data-hero")) {
                        e.attribs["data-hero"] = "";
                    }
                    const o = [
                        "alt",
                    ...
                    for (const r of o){
                        if (s(e, r)) {
                            t.attribs[r] = e.attribs[r];
                        }
                    }
                    const c = [];
                    const l = e.attribs["object-fit"];
                    if (l) {
                        c.push("object-fit:".concat(l));
                    }
                    const u = e.attribs["object-position"];
                    if (u) {
                        c.push("object-position:".concat(u));
                    }
                    if (c.length > 0) {
                        t.attribs.style = c.join(";");
                    }
                    i(e, t);
                }
                getNoscriptFallbackImage(e) {
                    const t = l(e, "noscript");
                    if (!t) {
                        return null;
                    }
                    return l(t, "img");
                }
                isMarkedAsHeroImage(e) {
                    while(e){
                        if (!e.tagName) {
                            e = e.parent;
                            continue;
                ...
                constructor(e){
                    this.log = e.log;
                    this.enabled = e.optimizeHeroImages !== false || e.preloadHeroImage !== false;
                    this.maxHeroImageCount = e.maxHeroImageCount || g;
                    if (e.preloadHeroImage) {
                        this.log.info("`preloadHeroImage` option has been deprecated. Use `optimizeHeroImages` instead");
                    }
                }
            }
            e.exports = OptimizeHeroImage;
        },
        411: (e, t, r)=>{
            "use strict";
            const { hasAttribute: i, nextNode: n, firstChildByTag: s } = r(3954);
            const { skipNodeAndChildren: a } = r(1764);
            const { isValidImageSrcURL: o } = r(5664);
            const { isTemplate: c } = r(211);
            const l = 100;
            const u = [
                39,
                47,
            ...
            class SrcsetWidth {
                setBaseWidth(e) {
                    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : -1, r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : d;
                ...
                constructor(e, t = -1, r = d){
                    this.widthList_ = [];
                    this.setBaseWidth(e, t, r);
                }
            }
            class OptimizeImages {
                ...
                async optimizeImage(e) {
                    ...
                    const r = e.attribs.width;
                    if (isNaN(Number.parseInt(r))) {
                        return;
                    }
                    const { layout: n, height: s, sizes: a } = e.attribs;
                    const c = n === "responsive" || !n && s && a;
                    if (c && r < l) {
                        return;
                    }
                    ...
                    while(u.moreWidth()){
                        const e = u.nextWidth();
                        try {
                            const r = await this.imageOptimizer(t, e);
                            if (r) {
                                if (!u.moreWidth()) {
                                    f += r;
                                } else {
                                    f += "".concat(r, " ").concat(e, "w, ");
                                }
                            }
                        } catch (e) {
                            this.log.error("Exception when optimizing image", t, e);
                        }
                    }
                    if (f) {
                        e.attribs.srcset = f;
                        this.log.debug("Generating img srcset", t, e.attribs.srcset);
                    }
                }
                constructor(e){
                    this.log = e.log;
                    this.imageOptimizer = e.imageOptimizer;
                    this.maxImageWidth = f;
                    this.maxSrcsetValues = d;
                }
            }
            e.exports = OptimizeImages;
        },
        5825: (e, t, r)=>{
            "use strict";
            e.exports = r(5661);
        ...
        5181: (e, t, r)=>{
            "use strict";
            const { createElement: i, nextNode: n, insertAfter: s, firstChildByTag: a } = r(3954);
            const { findMetaViewport: o, skipNodeAndChildren: c } = r(1764);
            const { isTemplate: l } = r(211);
            const u = 5;
            class PreloadImages {
                transform(e, t) {
                    const r = t.imagePreloadCount || u;
                    const i = a(e, "html");
                    const f = a(i, "head");
                    const d = a(i, "body");
                    const p = new Map;
                ...
                addImage(e, t) {
                    const r = this.extractImageUrl(t);
                    if (!r) {
                        return;
                    }
                    if (t.attribs.srcset) {
                    ...
                    e.set(r, this.createPreload(r, t.attribs.media));
                }
                extractImageUrl(e) {
                    if (!e.attribs) {
                        return null;
        ...
        570: (e, t, r)=>{
            ...
            class PruneDuplicateResourceHints {
                transform(e) {
                    ...
                    const s = [];
                    for(let e = n.firstChild; e !== null; e = e.nextSibling){
                        if (this._notPruneableHintLink(e)) {
                            s.push(e);
                        } else if (!this._alreadyLoaded(e, t)) {
                            this._markPreloaded(e, t);
                            s.push(e);
                        }
                    }
                    n.childNodes = s;
                }
                _notPruneableHintLink(e) {
                    if (e.tagName !== "link") {
                        return true;
                    }
                    if (!e.attribs) {
                    ...
                    if (e.attribs.rel === "preload" && !e.attribs.as) {
                        return true;
                    }
                    return !n.has(e.attribs.rel);
                }
                _alreadyLoaded(e, t) {
                    const r = e.attribs.rel;
            ...
            e.exports = PruneDuplicateResourceHints;
        },
        3781: (e, t, r)=>{
            "use strict";
            const { firstChildByTag: i } = r(3954);
            const { AMP_TAGS: n } = r(211);
            class RemoveAmpAttribute {
                transform(e) {
                    ...
                    for(let e = 0, r = n.length; e < r; e++){
                        delete t.attribs[n[e]];
                    }
                }
            }
            e.exports = RemoveAmpAttribute;
        },
        6924: (e, t, r)=>{
            "use strict";
            const { hasAttribute: i, firstChildByTag: n, nextNode: s } = r(3954);
            ...
            e.exports = RemoveCspNonce;
        },
        8710: (e, t, r)=>{
            "use strict";
            const { appendChild: i, appendAll: n, hasAttribute: s, firstChildByTag: a } = r(3954);
            const { isRenderDelayingExtension: o } = r(3585);
            class HeadNodes {
                register(e) {
                    e.forEach(this._registerNode.bind(this));
                }
                uniquifyAndSortCustomElements() {
                    this._scriptRenderDelayingExtensions = this._sortExtensions(this._scriptRenderDelayingExtensions);
                    this._scriptNonRenderDelayingExtensions = this._sortExtensions(this._scriptNonRenderDelayingExtensions);
                }
                _sortExtensions(e) {
                    const t = new Map([
                        ...e
                    ].sort((e, t)=>e[0].localeCompare(t[0])));
                    return [].concat.apply([], Array.from(t.values()));
                }
                appendToHead(e) {
                    i(e, this._metaCharset);
                    i(e, this._metaViewport);
                    n(e, this._resourceHintLinks);
                    n(e, this._metaOther);
                    i(e, this._linkStyleAmpRuntime);
                    i(e, this._styleAmpRuntime);
                    n(e, this._scriptAmpEngine);
                    n(e, this._scriptRenderDelayingExtensions);
                    n(e, this._scriptNonRenderDelayingExtensions);
                    i(e, this._styleAmpCustom);
                    i(e, this._styleAmpBoilerplate);
                    i(e, this._noscript);
                    n(e, this._linkIcons);
                    n(e, this._linkStylesheetsBeforeAmpCustom);
                    n(e, this._others);
                }
                _registerNode(e) {
                    if (e.tagName === "meta") {
                        this._registerMeta(e);
                    } else if (e.tagName === "script") {
                        this._registerScript(e);
                    } else if (e.tagName === "style") {
                        this._registerStyle(e);
                    } else if (e.tagName === "link") {
                        this._registerLink(e);
                    } else if (e.tagName === "noscript") {
                        this._noscript = e;
                    } else if (e.tagName) {
                        this._others.push(e);
                    }
                ...
                _registerMeta(e) {
                    if (e.attribs.charset) {
                        this._metaCharset = e;
                        return;
                    }
                    if (e.attribs.name == "viewport") {
                        this._metaViewport = e;
                        return;
                    }
                    this._metaOther.push(e);
                }
                _registerScript(e) {
                    const t = s(e, "nomodule") ? 1 : 0;
                    const r = this._getName(e);
                    if (s(e, "src") && !r) {
                        this._scriptAmpEngine[t] = e;
                        return;
                    }
                    if (s(e, "custom-element")) {
                        if (o(e)) {
                            this._registerExtension(this._scriptRenderDelayingExtensions, r, t, e);
                            return;
                        }
                        this._registerExtension(this._scriptNonRenderDelayingExtensions, r, t, e);
                        return;
                    }
                    if (s(e, "custom-template")) {
                        this._registerExtension(this._scriptNonRenderDelayingExtensions, r, t, e);
                        return;
                    }
                    this._others.push(e);
                }
                _registerExtension(e, t, r, i) {
                    const n = e.get(t) || [];
                    n[r] = i;
                    e.set(t, n);
                }
                _registerStyle(e) {
                    if (s(e, "amp-runtime")) {
                        this._styleAmpRuntime = e;
                        return;
                    }
                    if (s("node, amp-custom")) {
                        this._styleAmpCustom = e;
                        return;
                    }
                    if (s(e, "amp-boilerplate") || s(e, "amp4ads-boilerplate")) {
                        this._styleAmpBoilerplate = e;
                        return;
                    }
                    this._others.push(e);
                }
                _registerLink(e) {
                    const t = e.attribs.rel;
                    if (t === "stylesheet") {
                        if (e.attribs.href.endsWith("/v0.css")) {
                            this._linkStyleAmpRuntime = e;
                            return;
                        }
                        if (!this._styleAmpCustom) {
                            this._linkStylesheetsBeforeAmpCustom.push(e);
                            return;
                        }
                    }
                    if (t === "icon" || t === "shortcut icon" || t === "icon shortcut") {
                        this._linkIcons.push(e);
                        return;
                    }
                    if (t === "preload" || t === "prefetch" || t === "dns-prefetch" || t === "preconnect" || t == "modulepreload") {
                        this._resourceHintLinks.push(e);
                        return;
                    }
                    this._others.push(e);
                }
                _getName(e) {
                    return e.attribs["custom-element"] || e.attribs["custom-template"];
                }
                constructor(){
            ...
            e.exports = ReorderHeadTransformer;
        },
        6550: (e, t, r)=>{
            "use strict";
            const { createElement: i, hasAttribute: n, firstChildByTag: s, insertAfter: a, insertBefore: o, remove: c } = r(3954);
            const { AMP_CACHE_HOST: l } = r(211);
            const { findMetaViewport: u } = r(1764);
            const { calculateHost: f } = r(8757);
            class RewriteAmpUrls {
                transform(e, t) {
                    ...
                    let l = i.firstChild;
                    let d = u(i);
                    const p = this.esmModulesEnabled || t.esmModulesEnabled;
                    t.esmModulesEnabled = p;
                    const h = !n(r, "i-amphtml-no-boilerplate");
                    const m = [];
                    while(l){
                        if (l.tagName === "script" && this._usesAmpCacheUrl(l.attribs.src)) {
                            l.attribs.src = this._replaceUrl(l.attribs.src, o);
                            if (p) {
                                const e = this._addEsm(l, h);
                                if (h && e) {
                                    m.push(e);
                                }
                            } else if (h) {
                                m.push(this._createPreload(l.attribs.src, "script"));
                            }
                        } else if (l.tagName === "link" && l.attribs.rel === "stylesheet" && this._usesAmpCacheUrl(l.attribs.href)) {
                            l.attribs.href = this._replaceUrl(l.attribs.href, o);
                            if (h) {
                                m.push(this._createPreload(l.attribs.href, "style"));
                            }
                    ...
                    if (!this._usesAmpCacheUrl(o) && !t.lts) {
                        try {
                            const e = new URL(o);
                            this._addMeta(i, "runtime-host", e.origin);
                        } catch (e) {
                            this.log.warn("ampUrlPrefix must be an absolute URL");
                        }
                    }
                    if (t.geoApiUrl && !t.lts) {
                        this._addMeta(i, "amp-geo-api", t.geoApiUrl);
                    }
                }
                _usesAmpCacheUrl(e) {
                    if (!e) {
                ...
                _replaceUrl(e, t) {
                    return t + e.substring(l.length);
                }
                _addEsm(e, t) {
                    let r = null;
                    const n = e.attribs.src.replace(/\.js$/, ".mjs");
                    if (t && this._shouldPreload(e.attribs.src)) {
                        const e = i("link", {
                            as: "script",
                    ...
                    const a = e.attribs["custom-element"];
                    if (a) {
                        s.attribs["custom-element"] = a;
                    }
                    const c = e.attribs["custom-template"];
                    if (c) {
                        s.attribs["custom-template"] = c;
                    }
                    o(e.parent, s, e);
                    e.attribs.type = "module";
                    e.attribs.crossorigin = "anonymous";
                    e.attribs.src = n;
                    return r;
                }
                _createPreload(e, t) {
                    if (!this._shouldPreload(e)) {
                        return null;
                    }
                    return i("link", {
                        rel: "preload",
                ...
                _shouldPreload(e) {
                    return e.endsWith("v0.js") || e.endsWith("v0.css");
                }
                _addMeta(e, t, r) {
                    const n = i("meta", {
                        name: t,
                ...
                constructor(e){
                    this.esmModulesEnabled = e.esmModulesEnabled !== false;
                    this.log = e.log;
                }
            }
            e.exports = RewriteAmpUrls;
        },
        9210: (e, t, r)=>{
            "use strict";
            const { insertText: i, createElement: n, hasAttribute: s, firstChildByTag: a } = r(3954);
            const o = r(7595);
            const c = r(977);
            const l = r(8937);
            const u = new Set([
            ...
            class SeparateKeyframes {
                async transform(e) {
                    ...
                    if (!r) return;
                    const f = a(t, "body") || r;
                    if (this.isAmpStory(f)) {
                        return;
                    }
                    let d;
                    let p;
                    r.children = r.children.filter((e)=>{
                        if (e.tagName !== "style") return true;
                        if (!p && s(e, "amp-keyframes")) {
                            p = e;
                            return false;
                        }
                        if (!d && s(e, "amp-custom")) {
                    ...
                    const keyframesPlugin = ()=>{
                        const e = this.logInvalid.bind(this);
                        return {
                    ...
                    const { css: b } = await c([
                        ...
                        this.log_.warn("Failed to process CSS", e.message);
                        return {
                            css: m
                        };
                    });
                    ...
                    if (!p) {
                        f.children = f.children.filter((e)=>{
                            if (e.tagName === "style" && s(e, "amp-keyframes")) {
                                p = e;
                                return false;
                            }
                            return true;
                    ...
                    const v = c.parse(y && y.data || "");
                    v.nodes = g.nodes.concat(v.nodes);
                    let w = "";
                    c.stringify(v, (e)=>{
                        w += e;
                    });
                    if (h.length > 0) {
                        const e = await c(h).process(w, {
                            from: undefined,
                            parser: o
                        });
                        w = e.css;
                ...
                logInvalid(e, t) {
                    this.log_.warn("Found invalid keyframe property '".concat(t, "' in '").concat(e, "' not moving to style[amp-keyframes]"));
                }
                isAmpStory(e) {
                    return e.children.some((e)=>e.tagName === "amp-story");
                }
                constructor(e){
                    this.log_ = e.log.tag("SeparateKeyframes");
                    this.minify = e.minify !== false;
                }
            }
            e.exports = SeparateKeyframes;
        },
        5230: (e, t, r)=>{
            "use strict";
            const { hasAttribute: i, remove: n, createElement: s, insertBefore: a, nextNode: o, firstChildByTag: c } = r(3954);
            const { skipNodeAndChildren: l } = r(1764);
            const { isRenderDelayingExtension: u, isCustomElement: f } = r(3585);
            const { applyLayout: d } = r(9112);
            const { isTemplate: p } = r(211);
            const h = r(1033);
            class ServerSideRendering {
                _hasAncestorWithTag(e, t) {
                ...
                transform(e) {
                    ...
                    let p = true;
                    for(let e = o; e; e = this.nextNonTemplateNode(e)){
                        t.addNode(e);
                        if (!f(e)) {
                            continue;
                        }
                        if (e.tagName === "amp-experiment" && this.isAmpExperimentUsed(e)) {
                            p = false;
                            this.log_.debug("cannot remove boilerplate: amp-experiment");
                        }
                        if (e.tagName === "amp-audio") {
                            p = false;
                    ...
                    const g = l.children && l.children.length ? l.children[0] : null;
                    a(l, m, g);
                    let b;
                    for(let e = l.firstChild; e; e = e.nextSibling){
                        if (e.tagName === "script" && i(e, "custom-element") && e.attribs["custom-element"] === "amp-experiment") {
                            continue;
                        }
                        if (u(e)) {
                            this.log_.debug("cannot remove boilerplate because of a render delaying extension: ", e.tagName);
                            p = false;
                        }
                        if (i(e, "amp-custom")) {
                            b = e;
                    ...
                    t.applyToCustomStyles(l, b);
                    if (!t.canRemoveBoilerplate) {
                        p = false;
                    }
                    if (!p) {
                        return;
                    ...
                    const y = [];
                    for(let e = l.firstChild; e; e = e.nextSibling){
                        if (e.tagName === "noscript" || e.tagName === "style" && i(e, "amp-boilerplate")) {
                            y.push(e);
                        }
                    }
                    for (const e of y){
                ...
                constructor(e){
                    this.log_ = e.log.tag("ServerSideRendering");
                }
            }
            e.exports = ServerSideRendering;
        },
        4178: (e, t, r)=>{
            "use strict";
            const i = r(7315).log.tag("AMP Runtime Version");
            const n = "https://cdn.ampproject.org";
            const s = "/rtv/metadata";
            const a = "/version.txt";
            const o = {
                canary: 0,
                prod: 1,
            ...
            class RuntimeVersion {
                async currentVersion() {
                    let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
                    if (e.ampUrlPrefix && !this.isAbsoluteUrl_(e.ampUrlPrefix)) {
                    ...
                    const r = e.ampUrlPrefix ? e.ampUrlPrefix.replace(/\/$/, "") : n;
                    let i = await this.getVersionFromRuntimeMetadata_(r, t);
                    if (!i && t === o.prod) {
                        i = await this.getVersionFromVersionTxt_(r, t);
                    }
                    return i;
                }
                async getVersionFromRuntimeMetadata_(e, t) {
                    const r = e + s;
                    i.debug("Fetching version from ".concat(r));
                    let n;
                    try {
                        n = await this.fetch_(r);
                    } catch (e) {}
                    if (!n || !n.ok) {
                    ...
                    let c;
                    if (t === o.canary) {
                        if (Array.isArray(a.diversions) && a.diversions[0] && a.diversions[0].startsWith(this.getRtvConfigCode_(t))) {
                            c = a.diversions[0];
                        }
                        if (!c) {
                ...
                async getVersionFromVersionTxt_(e, t) {
                    if (t !== o.prod) {
                        i.debug("version.txt lookup only supported for prod releases");
                        return;
                    }
                    let r = e + a;
                    i.debug("Falling back to ".concat(r));
                    let n;
                    try {
                        n = await this.fetch_(r);
                    } catch (e) {}
                    ...
                    return this.getRtvConfigCode_(t) + s;
                }
                getRtvConfigCode_(e) {
                    if (e === o.canary) {
                        return "00";
            ...
            e.exports = RuntimeVersion;
        },
        9874: (e, t, r)=>{
            "use strict";
            const { calculateHash: i } = r(649);
            e.exports = {
                calculateHash: i
            };
        },
        649: (e, t, r)=>{
            ...
            function calculateHash(e) {
                let { algorithm: t = s } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                const r = t.toLowerCase();
                if (!n.has(r)) {
                    throw new Error("Unsupported algorithm for CSP: ".concat(r));
                }
                if (typeof e === "string") {
                    e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e, "utf8");
                }
                const a = i.createHash(r);
                const o = a.update(e);
                const c = base64URLFormat(o.digest("base64"));
                return "".concat(r, "-").concat(c);
            }
            function base64URLFormat(e) {
        ...
        1822: (e)=>{
            class AmpValidatorRules {
                getTagsForFormat(e) {
                    ...
                    e = e.toLowerCase();
                    return this.tags.filter((r)=>r.htmlFormat.includes(e.toUpperCase()) && this.checkEntityFormat_(r, e) && this.checkEntityTransformed_(r, t)).map((r)=>{
                        r = Object.assign({}, r);
                        r.attrs = r.attrs.filter((r)=>this.checkEntityFormat_(r, e) && this.checkEntityTransformed_(r, t));
                        return r;
                    });
                }
                getExtension(e, t) {
                ...
                checkEntityTransformed_(e, t) {
                    const r = this.isEnabled_(e, "transformed");
                    const i = this.isDisabled_(e, "transformed");
                    if (t) {
                        return r !== false && i !== true;
                    }
                    return r !== true && i !== false;
                }
                checkEntityFormat_(e, t) {
                    t = t.toLowerCase();
                    const r = this.isEnabled_(e, t);
                    const i = this.isDisabled_(e, t);
                    return r !== false && i !== true;
                }
                isEnabled_(e, t) {
                    if (!e.enabledBy) {
                    ...
                    return e.enabledBy.includes(t);
                }
                isDisabled_(e, t) {
                    if (!e.disabledBy) {
                        return null;
                    }
                    return e.disabledBy.includes(t);
                }
                initRules_(e) {
                    this.initErrors_(e);
                    this.initAttrLists_(e);
                    this.initTags_(e);
                    this.initExtensions_(e);
                }
                initErrors_(e) {
                    this.errors = {};
                    for (const t of e.errorFormats){
                        const e = this.errors[t.code] || {};
                        e.format = t.format;
                        this.errors[t.code] = e;
                    }
                    for (const t of e.errorSpecificity){
                        const e = this.errors[t.code] || {};
                ...
                initAttrLists_(e) {
                    ...
                    for (const { name: t, attrs: r } of e.attrLists){
                        if (t.startsWith("$")) {
                            this.specialAttrLists_[t] = r;
                        } else {
                            this.attrLists_[t] = r;
                        }
                    }
                    this.specialAttrLists_.$AMP_LAYOUT_ATTRS.forEach((e)=>e.layout = true);
                    this.specialAttrLists_.$GLOBAL_ATTRS.forEach((e)=>e.global = true);
                }
                initTags_(e) {
                    this.tags = e.tags.filter((e)=>!e.extensionSpec).map((e)=>{
                        e.attrs = e.attrs || [];
                        if (e.attrLists) {
                            for (const t of e.attrLists){
                                e.attrs.push(...this.attrLists_[t]);
                            }
                            delete e.attrLists;
                        }
                        if (e.ampLayout) {
                            e.attrs.push(...this.specialAttrLists_.$AMP_LAYOUT_ATTRS);
                        }
                        e.attrs.push(...this.specialAttrLists_.$GLOBAL_ATTRS);
                        return e;
                    });
                }
                initExtensions_(e) {
                    this.extensions = e.tags.filter((e)=>e.extensionSpec).map((e)=>Object.assign({}, e.extensionSpec, {
                            htmlFormat: e.htmlFormat
                        }));
                    for (const e of this.extensions){
                        const t = e.name.toLowerCase();
                        for (let r of e.htmlFormat){
                            r = r.toLowerCase();
                            const i = "".concat(r, "|").concat(t);
                            this.extensionCache_[i] = e;
                        }
                    }
                }
                constructor(e){
            ...
            e.exports = AmpValidatorRules;
        },
        1379: (e, t, r)=>{
            const i = r(3114);
            const n = "https://cdn.ampproject.org/v0/validator.json";
            async function loadRemote(e) {
                const t = await i(e);
                return t.json();
            }
            async function loadRules(param) {
                let { url: e } = param;
                e = e || n;
                return loadRemote(e);
            }
        ...
        4404: function(e, t, r) {
            ...
            var n = this && this.__createBinding || (Object.create ? function(e, t, r, i) {
                if (i === undefined) i = r;
            ...
            function formatAttributes(e, t) {
                ...
                return Object.keys(e).map(function(r) {
                    ...
                    if (t.xmlMode === "foreign") {
                        r = (n = l.attributeNames.get(r)) !== null && n !== void 0 ? n : r;
                    }
                    if (!t.emptyAttrs && !t.xmlMode && s === "") {
                        return r;
                    }
                    return r + '="' + (t.decodeEntities ? c.encodeXML(s) : s.replace(/"/g, "&quot;")) + '"';
                }).join(" ");
            }
            var f = new Set([
                "area",
            ...
            function render(e, t) {
                ...
                var r = Array.isArray(e) || e.cheerio ? e : [
                    e
                ];
                var i = "";
            ...
            function renderTag(e, t) {
                var r;
                if (t.xmlMode === "foreign") {
                    e.name = (r = l.elementNames.get(e.name)) !== null && r !== void 0 ? r : e.name;
            ...
            function renderText(e, t) {
                var r = e.data || "";
                if (t.decodeEntities && !(e.parent && u.has(e.parent.name))) {
                    r = c.encodeXML(r);
                }
                return r;
            }
        ...
        4614: function(e, t, r) {
            ...
            function formatAttributes(e, t) {
                ...
                return Object.keys(e).map(function(r) {
                    ...
                    return r + '="' + (t.decodeEntities !== false ? c.encodeXML(s) : s.replace(/"/g, "&quot;")) + '"';
                }).join(" ");
            }
            var f = new Set([
                "area",
        ...
        945: function(e, t, r) {
            ...
            var n = this && this.__exportStar || function(e, t) {
            ...
            var c = function() {
                function DomHandler(e, t, r) {
                    ...
                    this.options = t !== null && t !== void 0 ? t : o;
                ...
                DomHandler.prototype.oncdatastart = function() {
                    var e = new s.Text("");
                    var t = new s.NodeWithChildren("cdata", [
                        e
                    ]);
                    this.addNode(t);
                    e.parent = t;
                ...
                DomHandler.prototype.addDataNode = function(e) {
                    this.addNode(e);
                    this.lastNode = e;
                };
                return DomHandler;
        ...
        274: function(e, t) {
            ...
            var s = function() {
                ...
                Object.defineProperty(Node.prototype, "nodeType", {
                    get: function() {
                        var e;
                        return (e = n.get(this.type)) !== null && e !== void 0 ? e : 1;
                    },
                    enumerable: false,
                    configurable: true
                });
            ...
            t.Comment = c;
            var l = function(e) {
                r(ProcessingInstruction, e);
                function ProcessingInstruction(t, r) {
                    var i = e.call(this, "directive", r) || this;
                    i.name = t;
                    return i;
                }
            ...
            var d = function(e) {
                r(Element, e);
                function Element(t, r, i) {
                    if (i === void 0) {
                        i = [];
                    }
                    var n = e.call(this, t === "script" ? "script" : t === "style" ? "style" : "tag", i) || this;
                    n.name = t;
                    n.attribs = r;
                    n.attribs = r;
                    return n;
            ...
            function cloneNode(e, t) {
                ...
                switch(e.type){
                    ...
                    case "style":
                        {
                            var s = e;
                            var a = t ? cloneChildren(s.children) : [];
                            var p = new d(s.name, i({}, s.attribs), a);
                            a.forEach(function(e) {
                                return e.parent = p;
                            });
                            if (s["x-attribsNamespace"]) {
                                p["x-attribsNamespace"] = i({}, s["x-attribsNamespace"]);
                            }
                            if (s["x-attribsPrefix"]) {
                                p["x-attribsPrefix"] = i({}, s["x-attribsPrefix"]);
                            }
                            r = p;
                            break;
                        }
                    case "cdata":
                        {
                            var h = e;
                            var a = t ? cloneChildren(h.children) : [];
                            var m = new u(e.type, a);
                            a.forEach(function(e) {
                                return e.parent = m;
                            });
                            r = m;
                    ...
                    case "root":
                        {
                            var g = e;
                            var a = t ? cloneChildren(g.children) : [];
                            var b = new f(a);
                            a.forEach(function(e) {
                                return e.parent = b;
                            });
        ...
        7847: function(e, t, r) {
            ...
            var l = function() {
                function DomHandler(e, t, r) {
                    ...
                    this.callback = e !== null && e !== void 0 ? e : null;
                    this.options = t !== null && t !== void 0 ? t : c;
                    this.elementCB = r !== null && r !== void 0 ? r : null;
                }
                DomHandler.prototype.onparserinit = function(e) {
                    this.parser = e;
                ...
                DomHandler.prototype.onopentag = function(e, t) {
                    ...
                    var i = new a.Element(e, t, undefined, r);
                    this.addNode(i);
                ...
                DomHandler.prototype.oncdatastart = function() {
                    var e = new a.Text("");
                    var t = new a.NodeWithChildren(s.ElementType.CDATA, [
                        e
                    ]);
                    this.addNode(t);
                    e.parent = t;
        ...
        3527: function(e, t, r) {
            ...
            function cloneNode(e, t) {
                ...
                if (isText(e)) {
                    ...
                    var i = t ? cloneChildren(e.children) : [];
                    var a = new h(e.name, n({}, e.attribs), i);
                    i.forEach(function(e) {
                        return e.parent = a;
                    });
                    if (e["x-attribsNamespace"]) {
                        a["x-attribsNamespace"] = n({}, e["x-attribsNamespace"]);
                    }
                    if (e["x-attribsPrefix"]) {
                        a["x-attribsPrefix"] = n({}, e["x-attribsPrefix"]);
                    }
                    r = a;
                } else if (isCDATA(e)) {
                    var i = t ? cloneChildren(e.children) : [];
                    var o = new d(s.ElementType.CDATA, i);
                    i.forEach(function(e) {
                        return e.parent = o;
                    });
                    r = o;
        ...
        4236: (e, t, r)=>{
            ...
            function find(e, t, r, n) {
                ...
                for(var a = 0, o = t; a < o.length; a++){
                    ...
                    if (r && i.hasChildren(c) && c.children.length > 0) {
                        var l = find(e, c.children, r, n);
                        s.push.apply(s, l);
                        n -= l.length;
                        if (n <= 0) break;
                    }
            ...
            function existsOne(e, t) {
                return t.some(function(t) {
                    return i.isTag(t) && (e(t) || t.children.length > 0 && existsOne(e, t.children));
                });
            }
        ...
        6576: function(e, t, r) {
            ...
            function getInnerHTML(e, t) {
                return n.hasChildren(e) ? e.children.map(function(e) {
            ...
            function getText(e) {
                ...
                if (n.isCDATA(e)) return getText(e.children);
        ...
        1699: (e, t, r)=>{
            ...
            var i = r(2254);
            e.exports.O = convert;
            function convert(e, t, r) {
                r = checkEncoding(r || "UTF-8");
                t = checkEncoding(t || "UTF-8");
                e = e || "";
                var i;
                if (r !== "UTF-8" && typeof e === "string") {
                    e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e, "binary");
                }
                if (r === t) {
                    if (typeof e === "string") {
                        i = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e);
                    } else {
                        i = e;
                    }
                } else {
                    try {
                        i = convertIconvLite(e, t, r);
                    } catch (t) {
                        console.error(t);
                        i = e;
                    }
                ...
                if (typeof i === "string") {
                    i = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(i, "utf-8");
                }
                return i;
            }
            function convertIconvLite(e, t, r) {
                if (t === "UTF-8") {
                    return i.decode(e, r);
                } else if (r === "UTF-8") {
                    return i.encode(e, t);
                } else {
                    return i.encode(i.decode(e, r), t);
                }
            }
        ...
        6674: function(e, t, r) {
            ...
            t.decodeHTMLStrict = getStrictDecoder(n.default);
        ...
        6032: function(e, t, r) {
            ...
            var n = i(r(4931));
            var s = getInverseObj(n.default);
            var a = getInverseReplacer(s);
            t.encodeXML = getInverse(s, a);
            var o = i(r(1859));
            var c = getInverseObj(o.default);
            var l = getInverseReplacer(c);
            t.encodeHTML = getInverse(c, l);
            ...
            function getInverseReplacer(e) {
                ...
                Object.keys(e).forEach(function(e) {
                    return e.length === 1 ? t.push("\\" + e) : r.push(e);
                });
                r.unshift("[" + t.join("") + "]");
            ...
            function astralReplacer(e, t) {
                var r = e.charCodeAt(0);
                var i = e.charCodeAt(1);
                var n = (r - 55296) * 1024 + i - 56320 + 65536;
            ...
            function getInverse(e, t) {
                return function(r) {
                    return r.replace(t, function(t) {
                        return e[t];
                    }).replace(f, astralReplacer).replace(u, singleCharReplacer);
                };
            }
            var d = getInverseReplacer(s);
            function escape(e) {
                return e.replace(d, singleCharReplacer).replace(f, astralReplacer).replace(u, singleCharReplacer);
            }
            t.escape = escape;
        },
        9280: (e, t, r)=>{
            ...
            t.encode = encode;
            var s = r(6032);
            t.encodeXML = s.encodeXML;
            t.encodeHTML = s.encodeHTML;
            t.escape = s.escape;
            t.encodeHTML4 = s.encodeHTML;
            t.encodeHTML5 = s.encodeHTML;
            var a = r(6674);
        ...
        3350: function(e, t, r) {
            ...
            var p = function(e) {
                ...
                FeedHandler.prototype.onend = function() {
                    ...
                    if (r.name === "feed") {
                        var n = r.children;
                        i.type = "atom";
                        addConditionally(i, "id", "id", n);
                        addConditionally(i, "title", "title", n);
                        var s = getAttribute("href", getOneElement("link", n));
                        if (s) {
                            i.link = s;
                        }
                        addConditionally(i, "description", "subtitle", n);
                        var a = fetch("updated", n);
                        if (a) {
                            i.updated = new Date(a);
                        }
                        addConditionally(i, "author", "email", n, true);
                        i.items = getElements("entry", n).map(function(e) {
                            var t = {};
                            var r = e.children;
                            ...
                            var n = fetch("summary", r) || fetch("content", r);
                            if (n) {
                                t.description = n;
                            }
                        ...
                        var n = (t = (e = getOneElement("channel", r.children)) === null || e === void 0 ? void 0 : e.children) !== null && t !== void 0 ? t : [];
                        i.type = r.name.substr(0, 3);
                        i.id = "";
                        addConditionally(i, "title", "title", n);
                        addConditionally(i, "link", "link", n);
                        addConditionally(i, "description", "description", n);
                        var a = fetch("lastBuildDate", n);
                        if (a) {
                            i.updated = new Date(a);
                        }
                        addConditionally(i, "author", "managingEditor", n, true);
                        i.items = getElements("item", r.children).map(function(e) {
                            var t = {};
                            var r = e.children;
            ...
            function getElements(e, t) {
                return l.getElementsByTagName(e, t, true);
            }
            function getOneElement(e, t) {
                return l.getElementsByTagName(e, t, true, 1)[0];
            }
            function fetch(e, t, r) {
                if (r === void 0) {
                    r = false;
                }
                return l.getText(l.getElementsByTagName(e, t, r, 1)).trim();
            }
            ...
            function addConditionally(e, t, r, i, n) {
                if (n === void 0) {
                    n = false;
                }
                var s = fetch(r, i, n);
        ...
        9825: function(e, t, r) {
            ...
            var d = function() {
                function Parser(e, t) {
                    ...
                    this.tokenizer = new ((s = t.Tokenizer) !== null && s !== void 0 ? s : n.default)(this.options, this);
                ...
                Parser.prototype.onopentagname = function(e) {
                    ...
                    if (!this.options.xmlMode && Object.prototype.hasOwnProperty.call(o, e)) {
                        var i = void 0;
                        while(this.stack.length > 0 && o[e].has(i = this.stack[this.stack.length - 1])){
                            this.onclosetag(i);
                        }
                    }
                    if (this.options.xmlMode || !c.has(e)) {
                        this.stack.push(e);
                        if (l.has(e)) {
                ...
                Parser.prototype.onopentagend = function() {
                    ...
                    if (!this.options.xmlMode && this.cbs.onclosetag && c.has(this.tagname)) {
                ...
                Parser.prototype.onclosetag = function(e) {
                    ...
                    if (this.stack.length && (this.options.xmlMode || !c.has(e))) {
                ...
                Parser.prototype.oncomment = function(e) {
                    ...
                    (n = (i = this.cbs).oncommentend) === null || n === void 0 ? void 0 : n.call(i);
                };
                Parser.prototype.oncdata = function(e) {
                    ...
                    if (this.options.xmlMode || this.options.recognizeCDATA) {
                        ...
                        (n = (i = this.cbs).ontext) === null || n === void 0 ? void 0 : n.call(i, e);
        ...
        3562: function(e, t, r) {
            ...
            var c = ifElseState("C", 24, 16);
            var l = ifElseState("D", 25, 16);
            var u = ifElseState("A", 26, 16);
            var f = ifElseState("T", 27, 16);
            var d = ifElseState("A", 28, 16);
            var p = consumeSpecialNameChar("R", 35);
            var h = consumeSpecialNameChar("I", 36);
            ...
            var w = ifElseState("T", 43, 1);
            var _ = consumeSpecialNameChar("Y", 45);
            var x = consumeSpecialNameChar("L", 46);
            var S = consumeSpecialNameChar("E", 47);
            var C = ifElseState("Y", 49, 1);
            var T = ifElseState("L", 50, 1);
            var A = ifElseState("E", 51, 1);
            var E = consumeSpecialNameChar("I", 54);
            var k = consumeSpecialNameChar("T", 55);
            var N = consumeSpecialNameChar("L", 56);
            var D = consumeSpecialNameChar("E", 57);
            var B = ifElseState("I", 58, 1);
            var O = ifElseState("T", 59, 1);
            var I = ifElseState("L", 60, 1);
            var P = ifElseState("E", 61, 1);
            var L = ifElseState("#", 63, 64);
        ...
        250: function(e, t, r) {
            ...
            var n = this && this.__setModuleDefault || (Object.create ? function(e, t) {
                Object.defineProperty(e, "default", {
                    enumerable: true,
                    value: t
                });
            ...
            var s = this && this.__importStar || function(e) {
                ...
                var t = {};
                if (e != null) {
                    for(var r in e)if (r !== "default" && Object.prototype.hasOwnProperty.call(e, r)) i(t, e, r);
                }
                n(t, e);
                return t;
            };
        ...
        9473: (e, t, r)=>{
            ...
            var i = r(983).Buffer;
            t._dbcs = DBCSCodec;
            var n = -1, s = -2, a = -10, o = -1e3, c = new Array(256), l = -1;
            for(var u = 0; u < 256; u++)c[u] = n;
            function DBCSCodec(e, t) {
                ...
                if (typeof e.gb18030 === "function") {
                    ...
                    this.decodeTables.push(c.slice(0));
                    var u = this.decodeTables[0];
                    for(var i = 129; i <= 254; i++){
                        var f = this.decodeTables[o - u[i]];
                        for(var d = 48; d <= 57; d++){
                            if (f[d] === n) {
                                f[d] = o - a;
                            } else if (f[d] > o) {
                ...
                this.encodeTableSeq = [];
                var b = {};
                if (e.encodeSkipVals) for(var i = 0; i < e.encodeSkipVals.length; i++){
                    var y = e.encodeSkipVals[i];
                    if (typeof y === "number") b[y] = true;
                    else for(var d = y.from; d <= y.to; d++)b[d] = true;
                }
                this._fillEncodeTable(0, 0, b);
                if (e.encodeAdd) {
                    for(var v in e.encodeAdd)if (Object.prototype.hasOwnProperty.call(e.encodeAdd, v)) this._setEncodeChar(v.charCodeAt(0), e.encodeAdd[v]);
                }
                this.defCharSB = this.encodeTable[0][t.defaultCharSingleByte.charCodeAt(0)];
                if (this.defCharSB === n) this.defCharSB = this.encodeTable[0]["?"];
                if (this.defCharSB === n) this.defCharSB = "?".charCodeAt(0);
            }
            ...
            DBCSCodec.prototype._getDecodeTrieNode = function(e) {
                ...
                for(var i = t.length - 1; i > 0; i--){
                    var s = r[t[i]];
                    if (s == n) {
                        r[t[i]] = o - this.decodeTables.length;
                        this.decodeTables.push(r = c.slice(0));
                    } else if (s <= o) {
                        r = this.decodeTables[o - s];
                    } else throw new Error("Overwrite byte in " + this.encodingName + ", addr: " + e.toString(16));
                }
                return r;
            };
                    ...
                    if (typeof n === "string") {
                        for(var s = 0; s < n.length;){
                            ...
                            if (55296 <= o && o < 56320) {
                                ...
                                if (56320 <= c && c < 57344) r[t++] = 65536 + (o - 55296) * 1024 + (c - 56320);
                                else throw new Error("Incorrect surrogate pair in " + this.encodingName + " at chunk " + e[0]);
                            } else if (4080 < o && o <= 4095) {
                                var l = 4095 - o + 2;
                                var u = [];
                                for(var f = 0; f < l; f++)u.push(n.charCodeAt(s++));
                        ...
                        var d = r[t - 1] + 1;
                        for(var s = 0; s < n; s++)r[t++] = d++;
                    } else throw new Error("Incorrect type '" + typeof n + "' given in " + this.encodingName + " at chunk " + e[0]);
                }
            ...
            DBCSCodec.prototype._getEncodeBucket = function(e) {
                var t = e >> 8;
                if (this.encodeTable[t] === undefined) this.encodeTable[t] = c.slice(0);
                return this.encodeTable[t];
            };
            DBCSCodec.prototype._setEncodeChar = function(e, t) {
                var r = this._getEncodeBucket(e);
                var i = e & 255;
                if (r[i] <= a) this.encodeTableSeq[a - r[i]][l] = t;
                else if (r[i] == n) r[i] = t;
            };
            DBCSCodec.prototype._setEncodeSequence = function(e, t) {
                var r = e[0];
                var i = this._getEncodeBucket(r);
                var s = r & 255;
                var o;
                if (i[s] <= a) {
                    o = this.encodeTableSeq[a - i[s]];
                } else {
                    o = {};
                    if (i[s] !== n) o[l] = i[s];
                    i[s] = a - this.encodeTableSeq.length;
                    this.encodeTableSeq.push(o);
                }
                for(var c = 1; c < e.length - 1; c++){
                    var u = o[r];
                    if (typeof u === "object") o = u;
                    else {
                        o = o[r] = {};
                        if (u !== undefined) o[l] = u;
                    }
                }
                r = e[e.length - 1];
                o[r] = t;
            ...
            DBCSCodec.prototype._fillEncodeTable = function(e, t, r) {
                ...
                for(var c = 0; c < 256; c++){
                    ...
                    if (r[u]) continue;
                    if (l >= 0) {
                        this._setEncodeChar(l, u);
                        n = true;
                    } else if (l <= o) {
                        var f = o - l;
                        if (!s[f]) {
                            var d = u << 8 >>> 0;
                            if (this._fillEncodeTable(f, d, r)) n = true;
                            else s[f] = true;
                        }
                    } else if (l <= a) {
                        this._setEncodeSequence(this.decodeTableSeq[a - l], u);
                        n = true;
                    }
                }
                return n;
            ...
            DBCSEncoder.prototype.write = function(e) {
                var t = i.alloc(e.length * (this.gb18030 ? 4 : 3)), r = this.leadSurrogate, s = this.seqObj, o = -1, c = 0, u = 0;
                while(true){
                    if (o === -1) {
                        if (c == e.length) break;
                    ...
                    if (s !== undefined && f != n) {
                        ...
                        var h = this.encodeTable[f >> 8];
                        if (h !== undefined) d = h[f & 255];
                        if (d <= a) {
                            s = this.encodeTableSeq[a - d];
                            continue;
                        }
                        if (d == n && this.gb18030) {
                            var m = findIdx(this.gb18030.uChars, f);
                            if (m != -1) {
                                var d = this.gb18030.gbChars[m] + (f - this.gb18030.uChars[m]);
                                t[u++] = 129 + Math.floor(d / 12600);
                                d = d % 12600;
                                t[u++] = 48 + Math.floor(d / 1260);
                                d = d % 1260;
                                t[u++] = 129 + Math.floor(d / 10);
                                d = d % 10;
                                t[u++] = 48 + d;
                                continue;
                            }
                    ...
                    if (d === n) d = this.defaultCharSingleByte;
                    if (d < 256) {
                        t[u++] = d;
                    } else if (d < 65536) {
                        t[u++] = d >> 8;
            ...
            DBCSDecoder.prototype.write = function(e) {
                var t = i.alloc(e.length * 2), r = this.nodeIdx, c = this.prevBytes, l = this.prevBytes.length, u = -this.prevBytes.length, f;
                for(var d = 0, p = 0; d < e.length; d++){
                    var h = d >= 0 ? e[d] : c[d + l];
                    var f = this.decodeTables[r][h];
                    if (f >= 0) {} else if (f === n) {
                        f = this.defaultCharUnicode.charCodeAt(0);
                        d = u;
                    } else if (f === s) {
                        if (d >= 3) {
                            var m = (e[d - 3] - 129) * 12600 + (e[d - 2] - 48) * 1260 + (e[d - 1] - 129) * 10 + (h - 48);
                        } else {
                            var m = (c[d - 3 + l] - 129) * 12600 + ((d - 2 >= 0 ? e[d - 2] : c[d - 2 + l]) - 48) * 1260 + ((d - 1 >= 0 ? e[d - 1] : c[d - 1 + l]) - 129) * 10 + (h - 48);
                        }
                        var g = findIdx(this.gb18030.gbChars, m);
                        f = this.gb18030.uChars[g] + m - this.gb18030.gbChars[g];
                    } else if (f <= o) {
                        r = o - f;
                        continue;
                    } else if (f <= a) {
                        var b = this.decodeTableSeq[a - f];
                        ...
                        f = b[b.length - 1];
                    } else throw new Error("iconv-lite internal error: invalid decoding table value " + f + " at " + r + "/" + h);
                    if (f >= 65536) {
                        f -= 65536;
                        var v = 55296 | f >> 10;
                        t[p++] = v & 255;
                ...
                this.nodeIdx = r;
                this.prevBytes = u >= 0 ? Array.prototype.slice.call(e, u) : c.slice(u + l).concat(Array.prototype.slice.call(e));
                return t.slice(0, p).toString("ucs2");
            };
        ...
        3421: (e, t, r)=>{
            ...
            for(var n = 0; n < i.length; n++){
                var s = i[n];
                for(var a in s)if (Object.prototype.hasOwnProperty.call(s, a)) t[a] = s[a];
            }
        },
        9494: (e, t, r)=>{
            "use strict";
            ...
            function InternalCodec(e, t) {
                ...
                if (this.enc === "base64") this.encoder = InternalEncoderBase64;
                    ...
                    if (i.from("eda0bdedb2a9", "hex").toString() !== "💩") {
            ...
            var n = r(1576).StringDecoder;
            if (!n.prototype.end) n.prototype.end = function() {};
            function InternalDecoder(e, t) {
                this.decoder = new n(t.enc);
            }
            InternalDecoder.prototype.write = function(e) {
                if (!i.isBuffer(e)) {
                    e = i.from(e);
                }
            ...
            InternalDecoderCesu8.prototype.write = function(e) {
                var t = this.acc, r = this.contBytes, i = this.accBytes, n = "";
                for(var s = 0; s < e.length; s++){
                    ...
                    if ((a & 192) !== 128) {
                        ...
                        if (r > 0) {
                            ...
                            i++;
                            if (r === 0) {
                                if (i === 2 && t < 128 && t > 0) n += this.defaultCharUnicode;
        ...
        7138: (e, t, r)=>{
            ...
            function SBCSCodec(e, t) {
                ...
                if (e.chars.length === 128) {
                    var r = "";
                    for(var n = 0; n < 128; n++)r += String.fromCharCode(n);
                    e.chars = r + e.chars;
                }
                this.decodeBuf = i.from(e.chars, "ucs2");
                var s = i.alloc(65536, t.defaultCharSingleByte.charCodeAt(0));
                for(var n = 0; n < e.chars.length; n++)s[e.chars.charCodeAt(n)] = n;
                this.encodeBuf = s;
            }
            ...
            SBCSEncoder.prototype.write = function(e) {
                var t = i.alloc(e.length);
                for(var r = 0; r < e.length; r++)t[r] = this.encodeBuf[e.charCodeAt(r)];
                return t;
            };
        ...
        3794: (e, t, r)=>{
            ...
            Utf16BEDecoder.prototype.write = function(e) {
                ...
                var t = i.alloc(e.length + 1), r = 0, n = 0;
            ...
            Utf16Decoder.prototype.write = function(e) {
                if (!this.decoder) {
                    ...
                    var t = detectEncoding(this.initialBufs, this.options.defaultEncoding);
                    this.decoder = this.iconv.getDecoder(t, this.options);
                    var r = "";
                    for(var i = 0; i < this.initialBufs.length; i++)r += this.decoder.write(this.initialBufs[i]);
            ...
            Utf16Decoder.prototype.end = function() {
                if (!this.decoder) {
                    var e = detectEncoding(this.initialBufs, this.options.defaultEncoding);
                    this.decoder = this.iconv.getDecoder(e, this.options);
                    var t = "";
                    for(var r = 0; r < this.initialBufs.length; r++)t += this.decoder.write(this.initialBufs[r]);
            ...
            function detectEncoding(e, t) {
                ...
                if (s > n) return "utf-16be";
                if (s < n) return "utf-16le";
                return t || "utf-16le";
            }
        },
        6451: (e, t, r)=>{
            ...
            function Utf32Encoder(e, t) {
                this.isLE = t.isLE;
                this.highSurrogate = 0;
            }
            Utf32Encoder.prototype.write = function(e) {
                var t = i.from(e, "ucs2");
                var r = i.alloc(t.length * 2);
                var n = this.isLE ? r.writeUInt32LE : r.writeUInt32BE;
                var s = 0;
                for(var a = 0; a < t.length; a += 2){
                    var o = t.readUInt16LE(a);
                    var c = 55296 <= o && o < 56320;
                    var l = 56320 <= o && o < 57344;
                    if (this.highSurrogate) {
                        if (c || !l) {
                            n.call(r, this.highSurrogate, s);
                            s += 4;
                        } else {
                            var u = (this.highSurrogate - 55296 << 10 | o - 56320) + 65536;
                            n.call(r, u, s);
                            s += 4;
                            this.highSurrogate = 0;
                            continue;
                ...
                if (s < r.length) r = r.slice(0, s);
                return r;
            };
            Utf32Encoder.prototype.end = function() {
                if (!this.highSurrogate) return;
                var e = i.alloc(4);
                if (this.isLE) e.writeUInt32LE(this.highSurrogate, 0);
                else e.writeUInt32BE(this.highSurrogate, 0);
                this.highSurrogate = 0;
                return e;
            };
            function Utf32Decoder(e, t) {
                this.isLE = t.isLE;
                this.badChar = t.iconv.defaultCharUnicode.charCodeAt(0);
                this.overflow = [];
            }
            Utf32Decoder.prototype.write = function(e) {
                if (e.length === 0) return "";
                var t = 0;
                var r = 0;
                var n = i.alloc(e.length + 4);
                var s = 0;
                var a = this.isLE;
                var o = this.overflow;
                var c = this.badChar;
                if (o.length > 0) {
                    for(; t < e.length && o.length < 4; t++)o.push(e[t]);
                    if (o.length === 4) {
                        if (a) {
                            r = o[t] | o[t + 1] << 8 | o[t + 2] << 16 | o[t + 3] << 24;
                        } else {
                            r = o[t + 3] | o[t + 2] << 8 | o[t + 1] << 16 | o[t] << 24;
                        }
                        o.length = 0;
                        s = _writeCodepoint(n, s, r, c);
                    }
                }
                for(; t < e.length - 3; t += 4){
                    if (a) {
                        ...
                        r = e[t + 3] | e[t + 2] << 8 | e[t + 1] << 16 | e[t] << 24;
                    }
                    s = _writeCodepoint(n, s, r, c);
                }
                for(; t < e.length; t++){
                ...
                return n.slice(0, s).toString("ucs2");
            };
            function _writeCodepoint(e, t, r, i) {
                if (r < 0 || r > 1114111) {
                    r = i;
                }
                if (r >= 65536) {
            ...
            t.utf32 = Utf32AutoCodec;
            t.ucs4 = "utf32";
            function Utf32AutoCodec(e, t) {
                this.iconv = t;
            }
            Utf32AutoCodec.prototype.encoder = Utf32AutoEncoder;
            Utf32AutoCodec.prototype.decoder = Utf32AutoDecoder;
            function Utf32AutoEncoder(e, t) {
                e = e || {};
                if (e.addBOM === undefined) e.addBOM = true;
                this.encoder = t.iconv.getEncoder(e.defaultEncoding || "utf-32le", e);
            }
            Utf32AutoEncoder.prototype.write = function(e) {
                return this.encoder.write(e);
            };
            Utf32AutoEncoder.prototype.end = function() {
                return this.encoder.end();
            };
            function Utf32AutoDecoder(e, t) {
                this.decoder = null;
                this.initialBufs = [];
                this.initialBufsLen = 0;
                this.options = e || {};
            ...
            Utf32AutoDecoder.prototype.write = function(e) {
                if (!this.decoder) {
                    this.initialBufs.push(e);
                    this.initialBufsLen += e.length;
            ...
            function detectEncoding(e, t) {
                ...
                e: for(var c = 0; c < e.length; c++){
                    ...
                    for(var u = 0; u < l.length; u++){
                        ...
                        if (r.length === 4) {
                            if (i === 0) {
                                if (r[0] === 255 && r[1] === 254 && r[2] === 0 && r[3] === 0) {
                                    return "utf-32le";
                                }
                                if (r[0] === 0 && r[1] === 0 && r[2] === 254 && r[3] === 255) {
                                    return "utf-32be";
                                }
                            }
                            if (r[0] !== 0 || r[1] > 16) s++;
                            if (r[3] !== 0 || r[2] > 16) n++;
                            if (r[0] === 0 && r[1] === 0 && (r[2] !== 0 || r[3] !== 0)) o++;
                            if ((r[0] !== 0 || r[1] !== 0) && r[2] === 0 && r[3] === 0) a++;
                            r.length = 0;
                            i++;
                            if (i >= 100) {
                                break e;
                ...
                if (o - s > a - n) return "utf-32be";
                if (o - s < a - n) return "utf-32le";
                return t || "utf-32le";
            }
        },
        5516: (e, t, r)=>{
            ...
            Utf7Encoder.prototype.write = function(e) {
                return i.from(e.replace(n, (function(e) {
            ...
            var s = /[A-Za-z0-9\/+]/;
            var a = [];
            for(var o = 0; o < 256; o++)a[o] = s.test(String.fromCharCode(o));
            var c = "+".charCodeAt(0), l = "-".charCodeAt(0), u = "&".charCodeAt(0);
            Utf7Decoder.prototype.write = function(e) {
                var t = "", r = 0, n = this.inBase64, s = this.base64Accum;
                for(var o = 0; o < e.length; o++){
                    if (!n) {
                        if (e[o] == c) {
                            t += this.iconv.decode(e.slice(r, o), "ascii");
                            r = o + 1;
                            n = true;
                        }
                    } else {
                        if (!a[e[o]]) {
                            if (o == r && e[o] == l) {
                                ...
                                var u = s + this.iconv.decode(e.slice(r, o), "ascii");
                                t += this.iconv.decode(i.from(u, "base64"), "utf16-be");
                            }
                            if (e[o] != l) o--;
                            r = o + 1;
                            n = false;
                ...
                if (!n) {
                    ...
                    var u = s + this.iconv.decode(e.slice(r), "ascii");
                    var f = u.length - u.length % 8;
                    s = u.slice(f);
                    u = u.slice(0, f);
                    t += this.iconv.decode(i.from(u, "base64"), "utf16-be");
                }
            ...
            Utf7Decoder.prototype.end = function() {
                var e = "";
                if (this.inBase64 && this.base64Accum.length > 0) e = this.iconv.decode(i.from(this.base64Accum, "base64"), "utf16-be");
                this.inBase64 = false;
                this.base64Accum = "";
                return e;
            };
            ...
            Utf7IMAPEncoder.prototype.write = function(e) {
                var t = this.inBase64, r = this.base64Accum, n = this.base64AccumIdx, s = i.alloc(e.length * 5 + 10), a = 0;
                for(var o = 0; o < e.length; o++){
                    var c = e.charCodeAt(o);
                    if (32 <= c && c <= 126) {
                        if (t) {
                            if (n > 0) {
                                a += s.write(r.slice(0, n).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), a);
                                n = 0;
                            }
                            s[a++] = l;
                            t = false;
                        ...
                        if (t) {
                            ...
                            r[n++] = c & 255;
                            if (n == r.length) {
                                a += s.write(r.toString("base64").replace(/\//g, ","), a);
                                n = 0;
                            }
                        }
                    }
            ...
            Utf7IMAPEncoder.prototype.end = function() {
                ...
                if (this.inBase64) {
                    if (this.base64AccumIdx > 0) {
                        t += e.write(this.base64Accum.slice(0, this.base64AccumIdx).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), t);
                        this.base64AccumIdx = 0;
                    }
                    e[t++] = l;
                    this.inBase64 = false;
            ...
            Utf7IMAPDecoder.prototype.write = function(e) {
                    ...
                    if (!n) {
                        ...
                        if (!f[e[a]]) {
                            if (a == r && e[a] == l) {
                                ...
                                var o = s + this.iconv.decode(e.slice(r, a), "ascii").replace(/,/g, "/");
                                t += this.iconv.decode(i.from(o, "base64"), "utf16-be");
                            }
                            if (e[a] != l) a--;
                            r = a + 1;
                            n = false;
                ...
                if (!n) {
                    ...
                    var o = s + this.iconv.decode(e.slice(r), "ascii").replace(/,/g, "/");
                    var c = o.length - o.length % 8;
                    s = o.slice(c);
                    o = o.slice(0, c);
                    t += this.iconv.decode(i.from(o, "base64"), "utf16-be");
                }
        ...
        2254: (e, t, r)=>{
            "use strict";
            var i = r(983).Buffer;
            var n = r(9838), s = e.exports;
            s.encodings = null;
            s.defaultCharUnicode = "�";
            s.defaultCharSingleByte = "?";
            s.encode = function encode(e, t, r) {
                e = "" + (e || "");
                var n = s.getEncoder(t, r);
                var a = n.write(e);
                var o = n.end();
                return o && o.length > 0 ? i.concat([
                    a,
                    o
                ]) : a;
            };
            s.decode = function decode(e, t, r) {
                if (typeof e === "string") {
                    if (!s.skipDecodeWarning) {
                        console.error("Iconv-lite warning: decode()-ing strings is deprecated. Refer to https://github.com/ashtuchkin/iconv-lite/wiki/Use-Buffers-when-decoding");
                        s.skipDecodeWarning = true;
                    }
                    e = i.from("" + (e || ""), "binary");
                }
            ...
            s.encodingExists = function encodingExists(e) {
                try {
                    s.getCodec(e);
                    return true;
                } catch (e) {
            ...
            s._codecDataCache = {};
            s.getCodec = function getCodec(e) {
                if (!s.encodings) s.encodings = r(3421);
                var t = s._canonicalizeEncoding(e);
                var i = {};
                while(true){
                    var n = s._codecDataCache[t];
                    if (n) return n;
                    var a = s.encodings[t];
                    switch(typeof a){
                        case "string":
                        ...
                        case "object":
                            ...
                            if (!i.encodingName) i.encodingName = t;
                            t = a.type;
                            break;
                        case "function":
                            if (!i.encodingName) i.encodingName = t;
                            n = new a(i, s);
                            s._codecDataCache[i.encodingName] = n;
                            return n;
                        default:
            ...
            s.getEncoder = function getEncoder(e, t) {
                var r = s.getCodec(e), i = new r.encoder(t, r);
                if (r.bomAware && t && t.addBOM) i = new n.PrependBOM(i, t);
                return i;
            };
            s.getDecoder = function getDecoder(e, t) {
                var r = s.getCodec(e), i = new r.decoder(t, r);
                if (r.bomAware && !(t && t.stripBOM === false)) i = new n.StripBOM(i, t);
                return i;
            };
            s.enableStreamingAPI = function enableStreamingAPI(e) {
                if (s.supportsStreams) return;
                var t = r(8178)(e);
                s.IconvLiteEncoderStream = t.IconvLiteEncoderStream;
                s.IconvLiteDecoderStream = t.IconvLiteDecoderStream;
                s.encodeStream = function encodeStream(e, t) {
                    return new s.IconvLiteEncoderStream(s.getEncoder(e, t), t);
                };
                s.decodeStream = function decodeStream(e, t) {
                    return new s.IconvLiteDecoderStream(s.getDecoder(e, t), t);
                };
                s.supportsStreams = true;
            };
            var a;
            try {
                a = r(2781);
            ...
            if (a && a.Transform) {
                s.enableStreamingAPI(a);
            } else {
                s.encodeStream = s.decodeStream = function() {
        ...
        8178: (e, t, r)=>{
            ...
            e.exports = function(e) {
                var t = e.Transform;
                function IconvLiteEncoderStream(e, r) {
                    this.conv = e;
                    r = r || {};
                    r.decodeStrings = false;
                    t.call(this, r);
                }
                IconvLiteEncoderStream.prototype = Object.create(t.prototype, {
                    constructor: {
                        value: IconvLiteEncoderStream
                    }
                });
                IconvLiteEncoderStream.prototype._transform = function(e, t, r) {
                    if (typeof e != "string") return r(new Error("Iconv encoding stream needs strings as its input."));
                    try {
                        var i = this.conv.write(e);
                        if (i && i.length) this.push(i);
                        r();
                    } catch (e) {
                        r(e);
                    }
                ...
                function IconvLiteDecoderStream(e, r) {
                    this.conv = e;
                    r = r || {};
                    r.encoding = this.encoding = "utf8";
                    t.call(this, r);
                }
                IconvLiteDecoderStream.prototype = Object.create(t.prototype, {
                    constructor: {
                        value: IconvLiteDecoderStream
                    }
                });
                IconvLiteDecoderStream.prototype._transform = function(e, t, r) {
                    if (!i.isBuffer(e) && !(e instanceof Uint8Array)) return r(new Error("Iconv decoding stream needs buffers as its input."));
                    try {
                        var n = this.conv.write(e);
                        if (n && n.length) this.push(n, this.encoding);
                        r();
                    } catch (e) {
                        r(e);
                    }
        ...
        1471: (e, t, r)=>{
            ...
            var i = _interopDefault(r(2781));
            var n = _interopDefault(r(3685));
            var s = _interopDefault(r(7310));
            var a = _interopDefault(r(5687));
            var o = _interopDefault(r(9796));
            const c = i.Readable;
                ...
                constructor(){
                    ...
                    if (e) {
                        ...
                        for(let e = 0; e < n; e++){
                            const n = t[e];
                            let s;
                            if (n instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"]) {
                                s = n;
                            } else if (ArrayBuffer.isView(n)) {
                                s = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(n.buffer, n.byteOffset, n.byteLength);
                            } else if (n instanceof ArrayBuffer) {
                                s = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(n);
                            } else if (n instanceof Blob) {
                                s = n[l];
                            } else {
                                s = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(typeof n === "string" ? n : String(n));
                            }
                            i += s.length;
                            r.push(s);
                        }
                    }
                    this[l] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat(r);
            ...
            function Body(e) {
                ...
                if (e == null) {
                    ...
                    e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e.toString());
                } else if (isBlob(e)) ;
                else if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].isBuffer(e)) ;
                else if (Object.prototype.toString.call(e) === "[object ArrayBuffer]") {
                    e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e);
                } else if (ArrayBuffer.isView(e)) {
                    e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(e.buffer, e.byteOffset, e.byteLength);
                } else if (e instanceof i) ;
                else {
                    e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(String(e));
                }
                this[d] = {
                    body: e,
                    disturbed: false,
                ...
                if (e instanceof i) {
                    e.on("error", function(e) {
                        const r = e.name === "AbortError" ? e : new FetchError("Invalid response body while trying to fetch ".concat(t.url, ": ").concat(e.message), "system", e);
                        t[d].error = r;
                    });
                }
            }
            ...
            function consumeBody() {
                ...
                let t = this.body;
                if (t === null) {
                    return Body.Promise.resolve(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].alloc(0));
                }
                if (isBlob(t)) {
                    t = t.stream();
                }
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].isBuffer(t)) {
                ...
                let n = 0;
                let s = false;
                return new Body.Promise(function(i, a) {
                    let o;
                    if (e.timeout) {
                        o = setTimeout(function() {
                            s = true;
                            a(new FetchError("Response timeout while trying to fetch ".concat(e.url, " (over ").concat(e.timeout, "ms)"), "body-timeout"));
                        }, e.timeout);
                    }
                    ...
                    t.on("end", function() {
                        ...
                        clearTimeout(o);
                        try {
                            i(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat(r, n));
                        } catch (t) {
            ...
            function getTotalBytes(e) {
                ...
                if (t === null) {
                    ...
                    return t.size;
                } else if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].isBuffer(t)) {
                    return t.length;
            ...
            function writeToStream(e, t) {
                ...
                if (r === null) {
                    ...
                    r.stream().pipe(e);
                } else if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].isBuffer(r)) {
                    e.write(r);
                    e.end();
                } else {
                    r.pipe(e);
            ...
            const y = Object.setPrototypeOf({
                next () {
                    if (!this || Object.getPrototypeOf(this) !== y) {
            ...
            const v = Symbol("Response internals");
            const w = n.STATUS_CODES;
            class Response {
                get url() {
                    return this[v].url || "";
                }
                ...
                get ok() {
                    return this[v].status >= 200 && this[v].status < 300;
                }
                get redirected() {
                    return this[v].counter > 0;
                }
                get statusText() {
            ...
            const x = s.parse;
            const S = s.format;
            const C = "destroy" in i.Readable.prototype;
            ...
            function getNodeRequestOptions(e) {
                ...
                if (e.signal && e.body instanceof i.Readable && !C) {
            ...
            function fetch(e, t) {
                ...
                return new fetch.Promise(function(r, s) {
                    ...
                    const l = getNodeRequestOptions(c);
                    const u = (l.protocol === "https:" ? a : n).request;
                    const f = c.signal;
                    let d = null;
                    const p = function abort() {
                        let e = new AbortError("The user aborted a request.");
                        s(e);
                        if (c.body && c.body instanceof i.Readable) {
                            c.body.destroy(e);
                        }
                        if (!d || !d.body) return;
                        d.body.emit("error", e);
                    ...
                    function finalize() {
                        m.abort();
                        if (f) f.removeEventListener("abort", h);
                        clearTimeout(g);
                    }
                    if (c.timeout) {
                        m.once("socket", function(e) {
                            g = setTimeout(function() {
                                s(new FetchError("network timeout at: ".concat(c.url), "request-timeout"));
                                finalize();
                            }, c.timeout);
                        });
                    }
                    m.on("error", function(e) {
                        s(new FetchError("request to ".concat(c.url, " failed, reason: ").concat(e.message), "system", e));
                        finalize();
                    });
                    m.on("response", function(e) {
                        ...
                        if (fetch.isRedirect(e.statusCode)) {
                            ...
                            const n = i === null ? null : A(c.url, i);
                            switch(c.redirect){
                                case "error":
                                    s(new FetchError("uri requested responds with a redirect, redirect mode is set to error: ".concat(c.url), "no-redirect"));
                                    finalize();
                                    return;
                                case "manual":
                                    if (n !== null) {
                                ...
                                case "follow":
                                    ...
                                    if (c.counter >= c.follow) {
                                        s(new FetchError("maximum redirect reached at: ".concat(c.url), "max-redirect"));
                                        finalize();
                                        return;
                                    }
                                    const i1 = {
                                    ...
                                    if (e.statusCode === 303 || (e.statusCode === 301 || e.statusCode === 302) && c.method === "POST") {
                                        i1.method = "GET";
                                        i1.body = undefined;
                                        i1.headers.delete("content-length");
                                    }
                                    r(fetch(new Request(n, i1)));
                                    finalize();
                                    return;
                            }
                        }
                        ...
                        if (!c.compress || c.method === "HEAD" || a === null || e.statusCode === 204 || e.statusCode === 304) {
                            d = new Response(i, n);
                            r(d);
                            return;
                        }
                        const l = {
                            flush: o.Z_SYNC_FLUSH,
                            finishFlush: o.Z_SYNC_FLUSH
                        };
                        if (a == "gzip" || a == "x-gzip") {
                            i = i.pipe(o.createGunzip(l));
                            d = new Response(i, n);
                            r(d);
                            return;
                        }
                        if (a == "deflate" || a == "x-deflate") {
                            const t = e.pipe(new T);
                        ...
                        if (a == "br" && typeof o.createBrotliDecompress === "function") {
        ...
        5438: (e)=>{
            ...
            const t = /[\f\n\r\t\v ]{2,}/g;
            const r = " ";
            const normalize = (e)=>e.replace(t, r);
            e.exports = normalize;
        },
        983: (e, t, r)=>{
            "use strict";
            ...
            s.Buffer.prototype = n.prototype;
            ...
            if (!s.kStringMaxLength) {
                try {
                    s.kStringMaxLength = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].binding("buffer").kStringMaxLength;
                } catch (e) {}
            }
            if (!s.constants) {
                s.constants = {
        ...
        8937: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/cssnano-simple/index.js [app-client] (ecmascript)");
        },
        7330: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/lru-cache/index.js [app-client] (ecmascript)");
        },
        7595: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/postcss-safe-parser/safe-parse.js [app-client] (ecmascript)");
        },
        6794: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/terser/bundle.min.js [app-client] (ecmascript)");
        },
        2037: (e)=>{
            "use strict";
    ...
    if (typeof __nccwpck_require__ !== "undefined") __nccwpck_require__.ab = ("TURBOPACK compile-time value", "/ROOT/node_modules/next/dist/compiled/@ampproject/toolbox-optimizer") + "/";
    var __webpack_exports__ = __nccwpck_require__(5601);
    module.exports = __webpack_exports__;
})();
}),
]);

//# sourceMappingURL=node_modules_next_dist_compiled_%40ampproject_toolbox-optimizer_index_3306cb21.js.map