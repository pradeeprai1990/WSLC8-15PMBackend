...
"[project]/node_modules/next/dist/compiled/raw-body/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 */ var callSiteToString = __nccwpck_require__(477).callSiteToString;
            ...
            function log(e, t) {
                var r = eventListenerCount(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], "deprecation") !== 0;
                if (!r && this._ignored) {
                    return;
                }
                var a;
                ...
                if (r) {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].emit("deprecation", l);
                    return;
                }
                var h = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].stderr.isTTY ? formatColor : formatPlain;
                var b = h.call(this, p, a, f.slice(n));
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].stderr.write(b + "\n", "utf8");
            }
 ...
 */ var a = r(989)("http-errors");
                ...
                for(var c = 0; c < arguments.length; c++){
                    ...
                    switch(typeof n){
                        ...
                        case "number":
                            r = n;
                            if (c !== 0) {
                                a("non-first-argument status code; replace with createError(" + n + ", ...)");
                            }
                            break;
                        case "object":
                            i = n;
        ...
        164: (e, t, r)=>{
            ...
            var a = r(983).Buffer;
            t._dbcs = DBCSCodec;
            var i = -1, o = -2, c = -10, n = -1e3, s = new Array(256), f = -1;
            ...
            function DBCSCodec(e, t) {
                ...
                this.encodeTableSeq = [];
                var c = {};
                if (e.encodeSkipVals) for(var a = 0; a < e.encodeSkipVals.length; a++){
                ...
                if (e.encodeAdd) {
                    for(var u in e.encodeAdd)if (Object.prototype.hasOwnProperty.call(e.encodeAdd, u)) this._setEncodeChar(u.charCodeAt(0), e.encodeAdd[u]);
                }
            ...
            DBCSCodec.prototype._addDecodeChunk = function(e) {
                ...
                for(var a = 1; a < e.length; a++){
                    ...
                    if (typeof i === "string") {
                        for(var o = 0; o < i.length;){
                            ...
                            if (55296 <= n && n < 56320) {
                                ...
                                if (56320 <= s && s < 57344) r[t++] = 65536 + (n - 55296) * 1024 + (s - 56320);
                    ...
                    } else throw new Error("Incorrect type '" + typeof i + "' given in " + this.encodingName + " at chunk " + e[0]);
                }
            ...
            DBCSCodec.prototype._fillEncodeTable = function(e, t, r) {
                ...
                for(var i = 0; i < 256; i++){
                    ...
                    else if (o <= c) this._setEncodeSequence(this.decodeTableSeq[c - o], s);
                }
            };
            ...
            DBCSEncoder.prototype.write = function(e) {
                var t = a.alloc(e.length * (this.gb18030 ? 4 : 3)), r = this.leadSurrogate, o = this.seqObj, n = -1, s = 0, d = 0;
                while(true){
                    if (n === -1) {
                        if (s == e.length) break;
            ...
            DBCSDecoder.prototype.write = function(e) {
                var t = a.alloc(e.length * 2), r = this.nodeIdx, s = this.prevBuf, f = this.prevBuf.length, d = -this.prevBuf.length, u;
                if (f > 0) s = a.concat([
                    s,
                    e.slice(0, 10)
                ]);
                for(var p = 0, l = 0; p < e.length; p++){
                    ...
                    if (u >= 0) {} else if (u === i) {
                        ...
                        var v = (b[0] - 129) * 12600 + (b[1] - 48) * 1260 + (b[2] - 129) * 10 + (b[3] - 48);
                        ...
                        u = y[y.length - 1];
                    } else throw new Error("iconv-lite internal error: invalid decoding table value " + u + " at " + r + "/" + h);
                    if (u > 65535) {
                        u -= 65536;
        ...
        516: (e, t, r)=>{
            ...
            for(var i = 0; i < a.length; i++){
                var o = a[i];
                for(var c in o)if (Object.prototype.hasOwnProperty.call(o, c)) t[c] = o[c];
            }
        },
        156: (e, t, r)=>{
            "use strict";
            ...
            InternalDecoderCesu8.prototype.write = function(e) {
                var t = this.acc, r = this.contBytes, a = this.accBytes, i = "";
        ...
        546: (e, t, r)=>{
            ...
            Utf16BEDecoder.prototype.write = function(e) {
                ...
                var t = a.alloc(e.length + 1), r = 0, i = 0;
            ...
            Utf16Decoder.prototype.write = function(e) {
                if (!this.decoder) {
                    ...
                    var e = a.concat(this.initialBytes), t = detectEncoding(e, this.options.defaultEncoding);
            ...
            function detectEncoding(e, t) {
                ...
                if (e.length >= 2) {
                    if (e[0] == 254 && e[1] == 255) r = "utf-16be";
                        ...
                        var a = 0, i = 0, o = Math.min(e.length - e.length % 2, 64);
                        for(var c = 0; c < o; c += 2){
                            if (e[c] === 0 && e[c + 1] !== 0) i++;
                            if (e[c] !== 0 && e[c + 1] === 0) a++;
                        }
        ...
        486: (e, t, r)=>{
            ...
            Utf7Encoder.prototype.write = function(e) {
                return a.from(e.replace(i, (function(e) {
            ...
            var s = "+".charCodeAt(0), f = "-".charCodeAt(0), d = "&".charCodeAt(0);
            Utf7Decoder.prototype.write = function(e) {
                var t = "", r = 0, i = this.inBase64, o = this.base64Accum;
            ...
            Utf7Decoder.prototype.end = function() {
                var e = "";
                if (this.inBase64 && this.base64Accum.length > 0) e = this.iconv.decode(a.from(this.base64Accum, "base64"), "utf16-be");
                this.inBase64 = false;
                this.base64Accum = "";
                return e;
            };
            ...
            Utf7IMAPEncoder.prototype.write = function(e) {
                var t = this.inBase64, r = this.base64Accum, i = this.base64AccumIdx, o = a.alloc(e.length * 5 + 10), c = 0;
                for(var n = 0; n < e.length; n++){
                    var s = e.charCodeAt(n);
                    if (32 <= s && s <= 126) {
                        if (t) {
                            if (i > 0) {
                                c += o.write(r.slice(0, i).toString("base64").replace(/\//g, ",").replace(/=+$/, ""), c);
                                i = 0;
                            }
                            o[c++] = f;
                            t = false;
            ...
            e.exports = function(e) {
                ...
                e.extendNodeEncodings = function extendNodeEncodings() {
                    ...
                    o.prototype.toString = function(r, i, o) {
                        ...
                        if (a.isNativeEncoding(r)) return t.SlowBufferToString.call(this, r, i, o);
                    ...
                    o.prototype.write = function(r, i, o, c) {
                        ...
                        if (a.isNativeEncoding(c)) return t.SlowBufferWrite.call(this, r, i, o, c);
                    ...
                    a.byteLength = o.byteLength = function(r, i) {
                        ...
                        if (a.isNativeEncoding(i)) return t.BufferByteLength.call(this, r, i);
                        return e.encode(r, i).length;
                    };
                    t.BufferToString = a.prototype.toString;
                    a.prototype.toString = function(r, i, o) {
                        r = String(r || "utf8").toLowerCase();
                        if (a.isNativeEncoding(r)) return t.BufferToString.call(this, r, i, o);
                        if (typeof i == "undefined") i = 0;
                        if (typeof o == "undefined") o = this.length;
                        return e.decode(this.slice(i, o), r);
                    };
                    ...
                    a.prototype.write = function(r, i, o, c) {
                        ...
                        c = String(c || "utf8").toLowerCase();
                        if (a.isNativeEncoding(c)) return t.BufferWrite.call(this, r, n, s, f);
                        i = +i || 0;
                        var u = this.length - i;
                        if (!o) {
                            o = u;
        ...
        357: (e, t, r)=>{
            "use strict";
            var a = r(300).Buffer, i = r(781).Transform;
            e.exports = function(e) {
            ...
            IconvLiteDecoderStream.prototype._transform = function(e, t, r) {
                if (!a.isBuffer(e)) return r(new Error("Iconv decoding stream needs buffers as its input."));
                try {
 ...
 */ var a = r(666);
            ...
            function getRawBody(e, t, r) {
                ...
                if (!i && !/*TURBOPACK member replacement*/ __turbopack_context__.g.Promise) {
                    throw new TypeError("argument callback is required");
                }
                var c = o.encoding !== true ? o.encoding : "utf-8";
                var n = a.parse(o.limit);
                var s = o.length != null && !isNaN(o.length) ? parseInt(o.length, 10) : null;
                if (i) {
            ...
            function readStream(e, t, r, a, o) {
                ...
                if (a !== null && r !== null && r > a) {
                    return done(i(413, "request entity too large", {
                        expected: r,
                        length: r,
                        limit: a,
                ...
                if (e._decoder || s && (s.encoding || s.decoder)) {
                    return done(i(500, "stream encoding should not be set", {
                ...
                function onData(e) {
                    ...
                    f += e.length;
                    if (a !== null && f > a) {
                        done(i(413, "request entity too large", {
                            limit: a,
                            received: f,
                            type: "entity.too.large"
                        }));
                ...
                function onEnd(e) {
                    ...
                    if (e) return done(e);
                    if (r !== null && f !== r) {
                        done(i(400, "request size did not match content length", {
                            expected: r,
                            length: r,
                            received: f,
                        ...
                        var t = d ? u + (d.end() || "") : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].concat(u);
                        done(null, t);
                    }
                }
                function cleanup() {
 ...
 */ e.exports = unpipe;
        ...
        666: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/bytes/index.js [app-client] (ecmascript)");
        },
        17: (e)=>{
            "use strict";
    ...
    if (typeof __nccwpck_require__ !== "undefined") __nccwpck_require__.ab = ("TURBOPACK compile-time value", "/ROOT/node_modules/next/dist/compiled/raw-body") + "/";
...
//# sourceMappingURL=node_modules_next_dist_compiled_raw-body_index_a4865e83.js.map