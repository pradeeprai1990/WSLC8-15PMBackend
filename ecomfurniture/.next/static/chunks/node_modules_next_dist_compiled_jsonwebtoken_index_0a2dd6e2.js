...
"[project]/node_modules/next/dist/compiled/jsonwebtoken/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(()=>{
    var e = {
        ...
        186: (e, r, t)=>{
            const n = t(521);
            e.exports = n.satisfies(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].version, ">=15.7.0");
        },
        900: (e, r, t)=>{
            var n = t(521);
            e.exports = n.satisfies(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].version, "^6.12.0 || >=8.0.0");
        },
        444: (e, r, t)=>{
            const n = t(521);
            e.exports = n.satisfies(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].version, ">=16.9.0");
        },
        126: (e, r, t)=>{
            var n = t(958);
            e.exports = function(e, r) {
        ...
        253: (e, r, t)=>{
            ...
            e.exports = function(e, r) {
                ...
                const o = i[t];
                if (!o) {
                    throw new Error('Unknown key type "'.concat(t, '".'));
                }
                if (!o.includes(e)) {
                    throw new Error('"alg" parameter for "'.concat(t, '" key type must be one of: ').concat(o.join(", "), "."));
                }
                if (n) {
                    switch(t){
                        case "ec":
                            ...
                            const n = s[e];
                            if (t1 !== n) {
                                throw new Error('"alg" parameter "'.concat(e, '" requires curve "').concat(n, '".'));
                            }
                            break;
                        case "rsa-pss":
                            if (a) {
                                ...
                                if (n !== "sha".concat(t) || a !== n) {
                                    throw new Error('Invalid key for this operation, its RSA-PSS parameters do not meet the requirements of "alg" '.concat(e, "."));
                                }
                                if (i !== undefined && i > t >> 3) {
                                    throw new Error('Invalid key for this operation, its RSA-PSS parameter saltLength does not meet the requirements of "alg" '.concat(e, "."));
                                }
                            }
                            break;
                    }
        ...
        743: (e, r, t)=>{
            ...
            e.exports = function(e, r, t, a) {
                ...
                const o = typeof e === "object" && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].isBuffer(e);
                ...
                if (r != null && !(r instanceof d)) {
                    try {
                        ...
                        try {
                            r = y(typeof r === "string" ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(r) : r);
                        } catch (e) {
                ...
                if (u.alg.startsWith("HS") && r.type !== "secret") {
                    return failure(new Error("secretOrPrivateKey must be a symmetric key when using ".concat(u.alg)));
                } else if (/^(?:RS|PS|ES)/.test(u.alg)) {
                    if (r.type !== "private") {
                        return failure(new Error("secretOrPrivateKey must be an asymmetric key when using ".concat(u.alg)));
                    }
                    if (!t.allowInsecureKeySizes && !u.alg.startsWith("ES") && r.asymmetricKeyDetails !== undefined && r.asymmetricKeyDetails.modulusLength < 2048) {
                        return failure(new Error("secretOrPrivateKey has a minimum key size of 2048 bits for ".concat(u.alg)));
                    }
                }
                ...
                if (typeof a === "function") {
                    ...
                    s.createSign({
                        ...
                        if (!t.allowInsecureKeySizes && /^(?:RS|PS)/.test(u.alg) && e.length < 256) {
                            return a(new Error("secretOrPrivateKey has a minimum key size of 2048 bits for ".concat(u.alg)));
                        }
                        a(null, e);
                    });
                } else {
                    ...
                    if (!t.allowInsecureKeySizes && /^(?:RS|PS)/.test(u.alg) && n.length < 256) {
                        throw new Error("secretOrPrivateKey has a minimum key size of 2048 bits for ".concat(u.alg));
                    }
                    return n;
                }
            };
                ...
                return I(S, function(r, s) {
                    ...
                    if (s != null && !(s instanceof f)) {
                        try {
                            ...
                            try {
                                s = h(typeof s === "string" ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(s) : s);
                            } catch (e) {
                    ...
                    if (S.alg.startsWith("HS") && s.type !== "secret") {
                        return b(new n("secretOrPublicKey must be a symmetric key when using ".concat(S.alg)));
                    } else if (/^(?:RS|PS|ES)/.test(S.alg) && s.type !== "public") {
                        return b(new n("secretOrPublicKey must be an asymmetric key when using ".concat(S.alg)));
                    }
                    if (!t.allowInvalidAsymmetricKeyTypes) {
                        try {
                            u(S.alg, s);
 ...
 */ (function() {
                ...
                var tt = ("TURBOPACK compile-time value", "object") == "object" && /*TURBOPACK member replacement*/ __turbopack_context__.g && /*TURBOPACK member replacement*/ __turbopack_context__.g.Object === Object && /*TURBOPACK member replacement*/ __turbopack_context__.g;
        ...
        911: (e, r, t)=>{
            /*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */ var n = t(300);
            var a = n.Buffer;
        ...
        521: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/lib/semver-noop.js [app-client] (ecmascript)");
        },
        781: (e)=>{
            "use strict";
    ...
    if (typeof __nccwpck_require__ !== "undefined") __nccwpck_require__.ab = ("TURBOPACK compile-time value", "/ROOT/node_modules/next/dist/compiled/jsonwebtoken") + "/";
...
//# sourceMappingURL=node_modules_next_dist_compiled_jsonwebtoken_index_0a2dd6e2.js.map