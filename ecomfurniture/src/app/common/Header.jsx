...
import { logoOut } from '../redux/slice/userSlice';
...
export default function Header() {
  ...
  let dispatch =useDispatch() //Slice Method Call
      ...
      <header>
        ...
        <div className='border-b-1 border-[#eee] py-2'>
          <div className='max-w-[1320px] mx-auto text-[14px] flex justify-between'>
            <div>Contact us 24/7 : +91-9234504642 / furnitureinfo@gmail.com
            ...
            {loginUser ?
              ...
              <div>
                  {loginUser.userName}   | 
                  <button onClick={logOutuser} className='p-3 bg-red-400'>LogOut</button> 
