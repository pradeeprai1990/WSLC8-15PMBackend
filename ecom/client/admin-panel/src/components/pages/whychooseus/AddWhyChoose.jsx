                    ...
                    <form>
                        <div className='grid grid-cols-[30%_auto] gap-4'>
                            ...
                            <div className='w-full'>
                                ...
                                <input type='title' placeholder='Name' className=' w-full p-[8px] rounded-[8px] border border-gray-400 text-[14px] text-gray-400' />
                                ...
                                <h3 className='my-[10px] font-medium text-[14px]'>Description</h3>
                                <textarea placeholder='Description' className=' w-full p-[20px] rounded-[8px] border border-gray-400 text-[14px] text-gray-400'></textarea>
                            </div>
                        </div>
