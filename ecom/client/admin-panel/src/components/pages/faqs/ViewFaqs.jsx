                        ...
                        <tbody>
                            <tr class="bg-white dark:bg-gray-800">
                                ...
                                <td class="px-6 py-4 text-center">
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odio adipisci quas debitis molestias quos alias dicta nulla necessitatibus error commodi eum hic accusantium vero voluptatum accusamus neque rem, molestiae nam?
                                </td>
                                <td class="px-6 py-4 text-center">
                                    4
                                </td>
